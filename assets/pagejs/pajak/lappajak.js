...
var initTable;
//"use strict";
function tablePajakTrx(){
    // var lg = languageDatatable;
    var initTable = function () {
        var table = $('#tablelappajakTrx');
        table.DataTable({
            ...
            "ajax": {
                "url": HOST_URL + 'pajak/transaksi/list_lappajak',
                "type": "POST",
                "data": function(data) {
...
$('#btn-filter').on('click', function(){
    ...
    if (!$.fn.DataTable.isDataTable('#tablelappajakTrx')) {

        tablePajakTrx()

    } else {

        reload_tablePajakTrx()
...
//     var tableHtml = $('#tablelappajakTrx').clone();
