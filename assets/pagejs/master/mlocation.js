...
function tableMlocation(){
    ...
    var initTable = function () {
        ...
        table.DataTable({
            ...
            "ajax": {
                "url": HOST_URL + 'master/location/list_mlocation',
                "type": "POST",
                "data": function(data) {
...
function update_mlocation(id)
{
    ...
    $.ajax({
        url: HOST_URL + 'master/location/showing_data' + '/' + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="nmlocation"]').val(data.nmlocation).prop("readonly", false);
            $.ajax({
                type: 'GET',
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            if (validator.isValid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: HOST_URL + 'master/location/saveEntry' + '',
                    dataType: 'json',
