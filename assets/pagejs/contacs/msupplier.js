...
var table;
//"use strict";
function tableMsupplier(){
    // var lg = languageDatatable;
    var initTable = function () {
        var table = $('#tmsupplier');
        table.DataTable({
            ...
            "ajax": {
                "url": HOST_URL + 'contacts/supplier/list_msupplier',
                "type": "POST",
                "data": function(data) {
...
function add_msupplier()
{
    ...
    $('[name="type"]').val('INPUT');
    $('[name="id"]').val();
    $('[name="idsupplier"]').prop("disabled", true)
...
$("#profile_tab").on('click', function (e) {
    //alert('DATA DIRI');
    window.location.replace(HOST_URL + 'contacts/supplier/input_supplier#profile');
});
$("#alamat_tab").on('click', function (e) {
    window.location.replace(HOST_URL + 'contacts/supplier/input_supplier#alamat');
});
$("#bank_tab").on('click', function (e) {
    window.location.replace(HOST_URL + 'contacts/supplier/input_supplier#bank');
});
$("#hutang_tab").on('click', function (e) {
    window.location.replace(HOST_URL + 'contacts/supplier/input_supplier#hutang');
});
$("#npwp_tab").on('click', function (e) {
    window.location.replace(HOST_URL + 'contacts/supplier/input_supplier#npwp');
});

$(document).ready(function() {
    var the_string =window.location.href;
    ...
    } else if (parts[1]==='alamat'){
        $('#alamat').addClass('active');
        $('#alamat_tab').addClass('active');
    } else if (parts[1]==='bank'){
        $('#bank').addClass('active');
        $('#bank_tab').addClass('active');
    } else if (parts[1]==='hutang'){
        $('#hutang').addClass('active');
        $('#hutang_tab').addClass('active');
    } else if (parts[1]==='npwp'){
        $('#npwp').addClass('active');
        $('#npwp_tab').addClass('active');
    }
