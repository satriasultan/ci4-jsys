...
function tableCapitalPengajuan(){
    ...
    var initTable = function () {
        var table = $('#capital_pengajuan_persetujuan');
        table.DataTable({
            ...
            "ajax": {
                "url": HOST_URL + 'capital/administration/list_pengajuan_approvals_admin',
                "type": "POST",
                "data": function(data) {
...
function update_pengajuan(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="estprice_kdlvl"]').val(data.estprice_kdlvl).prop("readonly", false);
...
function persetujuan_pengajuan(id) {
    ...
    Swal.fire({
        title: 'Peringatan..!!!',
        text: 'Data akan disetujui, anda yakin...?',
        backdrop: true,
...
function tolak_pengajuan(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: 'GET',
                url: HOST_URL + 'capital/administration/tolak_persetujuan_mngr'  + '/' + id,
                dataType: 'json',
                delay: 250,
                success: function(data) {
                    if (data.status){
...
$("#kdlvl").on("change", function () {
    ...
    $.ajax({
        ...
        success: function(data)
        {
            $('[name="estprice_kdlvl"]').val(data.pricemax1).prop("readonly", false).trigger('change');
