...
class User extends BaseController
{
    public function index()
    {
        ...
        $kodemenu='I.M.A.5'; $versirelease='I.M.A.5/01'; $releasedate=date('2020-04-12 00:00:00');
    ...
    function list_user(){
        ...
        foreach ($list as $lm) {
            ...
            $row[] = '
              ...
              <a class="btn btn-danger btn-sm  btn-flat" href='."'". base_url('user/hps').'/'.''.$enc_iduser.'/'.$enc_username."'".'  title="Hapus Data User" onclick="return confirm('."'".'Detail Menu Programs ?  : '.trim($lm->username)."'".')"><i class="fa fa-trash-o"></i> </a>
              ';
            $row[] = $lm->username;
            $row[] = $lm->expdate1;
            $row[] = $lm->hold_id;
