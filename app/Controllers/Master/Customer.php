...
class Customer extends BaseController
{
    ...
    function list_customer(){
        ...
        foreach ($list as $lm) {
            ...
            $btnActions .= '<a class="dropdown-item" href="#" onclick="detailCustomer(\'' . trim($lm->id) . '\');">
                    <i class="fa fa-eye"></i> Detail Data</a>';

            $btnActions .= '<a class="dropdown-item" href="#" onclick="editCustomer(\'' . trim($lm->id) . '\');">
                <i class="fa fa-edit"></i> Update</a>';

            $btnActions .= '<a class="dropdown-item" href="#" onclick="hapusCustomer(\'' . trim($lm->id) . '\');">
