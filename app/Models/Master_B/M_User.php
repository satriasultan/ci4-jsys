...
class M_User extends Model
{
    ...
    var $t_user_view = "(select a.*,to_char(a.inputdate,'dd-mm-yyyy hh24:mi:ss') as inputdate1,to_char(a.expdate,'dd-mm-yyyy hh24:mi:ss') as expdate1,b.nmlocation as locaname,c.rolename,d.nmdept from sc_mst.user a
...
left outer join sc_mst.departmen d on a.kddept=d.kddept
    ...
    var $t_user_view_column = array('nik','username','expdate1','hold_id','locaname','nmdept');
