...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('persediaan/trans/final_ajustment_stock_mst') ?>" method="post" id="formAjustmentStockMaster">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Ajustment</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
...
<!--                                            </div>-->
                                            <div class="col-md-6">
                                                <label for="docref">NO REFERENSI</label>
...
<?php /*
                    <div class="float-right d-flex align-items-center gap-2">
                        ...
                        <button type="button"
                                ...
                                title="Update Data"
                                onclick="updateAjustmentStockDetail()">
...
*/ ?>
                ...
                <div class="card-footer bg-light">
                    <a href="<?= base_url('persediaan/trans/ajustment_stock') ?>"
        ...
        <div class="modal-content">
            ...
            <form id="formAjustmentStockDtl">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"
                            class="btn btn-primary saveAjusment"
                            onclick="saveAjustment()">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/persediaan/ajustment_stock/ajustment_stock_trx_detail.js') ?>"></script>
