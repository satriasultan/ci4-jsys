    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1 class="m-0"> Perintah Transfer Antar Lokasi</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
================================ */
    ...
    /* Rounded corner atas */
    #tSpkTransfers thead th:first-child {
        border-top-left-radius: 8px;
    }

    #tSpkTransfers thead th:last-child {
        border-top-right-radius: 8px;
    }

    /* Zebra row */
    #tSpkTransfers tbody tr:nth-child(even) {
        background-color: #f8f9fa;
    }

    /* Hover row */
    #tSpkTransfers tbody tr:hover {
        background-color: #e9f2ff;
        transition: 0.2s ease-in-out;
    }

    /* Center kolom kecil */
    #tSpkTransfers tbody td:nth-child(1),
    #tSpkTransfers tbody td:nth-child(2),
    #tSpkTransfers tbody td:nth-child(4),
    #tSpkTransfers tbody td:nth-child(7),
    #tSpkTransfers tbody td:nth-child(9) {
        text-align: center;
    }
    ...
    <div class="col-sm-12">
        <div class="card">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($dtl_akses['a_input']) && trim($dtl_akses['a_input']) === 't'): ?>
                            <a class="dropdown-item" href="<?= base_url('persediaan/trans/addSPKtransfers') ?>"><i class="fa fa-plus"></i><?php echo '   Input'; ?> </a>
                        <?php endif; ?>
            ...
            <div class="card-body table-responsive" style='overflow-x:scroll;'>
                <table id="tSpkTransfers" class="table table-bordered table-striped" >
                    <thead>
                    <tr>
                        <th width="1%">No.</th>
