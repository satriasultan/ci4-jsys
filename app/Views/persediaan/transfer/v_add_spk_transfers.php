...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('persediaan/trans/finalSpkTransfers') ?>" method="post" id="formPP">
        <div class="col-md-12">
            <!-- jquery validation -->
                ...
                <div class="card-body">
                        <div class="section-block">
                            <div class="section-header">
                                <i class="fa fa-address-card"></i> Surat Perintah Transfers
                            </div>
                            <div class="row">
            ...
            <div class="card mt-3 card-primary">
                <div class="card-header clearfix">
                    ...
                    <div class="float-right d-flex align-items-center gap-2">
                        ...
                        <button type="button"
                                ...
                                title="Update Data"
                                onclick="updateSPKTransferDetail()">
                ...
                <div class="card-footer bg-light">
                    <a href="<?= base_url('persediaan/trans/perintah_transfer') ?>"
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/persediaan/stock_transfers.js') ?>"></script>
