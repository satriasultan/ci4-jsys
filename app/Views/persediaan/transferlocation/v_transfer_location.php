    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1 class="m-0"> Transfer Antar Lokasi Barang</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="col-sm-12">
        <div class="card">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($dtl_akses['a_input']) && trim($dtl_akses['a_input']) === 't'): ?>
                            <a class="dropdown-item" href="<?= base_url('persediaan/trans/addTransferLokasi') ?>"><i class="fa fa-plus"></i><?php echo '   Input'; ?> </a>
                        <?php endif; ?>
            ...
            <div class="card-body table-responsive" style='overflow-x:scroll;'>
                <table id="tTrxTransferLocaton" class="table table-bordered table-striped" >
                    <thead>
                    <tr>
                        <th width="1%">No.</th>
