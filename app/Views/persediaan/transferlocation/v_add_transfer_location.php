...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('persediaan/trans/finalTransferLocation') ?>" method="post" id="formTransferLocationMasters">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Perintah Transfers</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                        <div class="section-block">
                            <div class="section-header">
                                <i class="fa fa-address-card"></i> Transfer Antar Gudang
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <label for="docref">NO SPKT</label>
                                                <input name="docref" id="docref" class="form-control">
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-6  border border-dark" >
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="cabang_sent">Cabang / Job</label>
                                                <select name="cabang_sent" id="cabang_sent" class="form-control" required></select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="idlocation">Gudang Kirim</label>
                                                <select name="idlocation_to" id="idlocation_to" class="form-control" required></select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="idlocation_transit">Transit</label>
                                                <select name="idlocation_transit" id="idlocation_transit" class="form-control" required></select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
            ...
            <div class="card mt-3 card-primary">
                <div class="card-header clearfix">
                    ...
                    <div class="float-right d-flex align-items-center gap-2">
                        ...
                        <button type="button"
                                ...
                                title="Update Data"
                                onclick="updateTransferLocationDetail()">
                ...
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <table id="tmptabspktransfersdtl"
                ...
                <div class="card-footer bg-light">
                    <a href="<?= base_url('persediaan/trans/transfer_lokasi') ?>"
...
<!-- ================= MODAL TAX DETAIL ================= -->
<div class="modal fade" id="modalDetailSPK" tabindex="-1" role="dialog" aria-labelledby="modalDetailPPLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">

            <!-- HEADER -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="modalDetailPPLabel">
                    Input Item Detail
                </h5>
            ...
            <form id="formSPKtransfersDtl">
                ...
                <div class="modal-footer bg-light">
                    <button type="button"
                            ...
                            onclick="saveTransferStock()">
                        <i class="fa fa-save"></i> Simpan
                    </button>
                    <button type="button"
                            class="btn btn-secondary"
                            data-bs-dismiss="modal"
                            onclick="$('#modalDetailSPK').modal('hide')">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/persediaan/transferlocation/stock_transfers_location.js') ?>"></script>
