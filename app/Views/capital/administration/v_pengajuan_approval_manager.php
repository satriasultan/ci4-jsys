    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Daftar Pengajuan Inventaris IT (Butuh Persetujuan Manager)</h3>
            </div>
            <div class="card-body">

            </div>
            <div class="card-body " style='overflow-x:scroll;'>
                <table id="capital_pengajuan_persetujuan" class="table table-bordered table-striped" >
                    <thead>
                    <tr>
                        <th width="1%">No.</th>
            ...
            <div class="modal-body form">
                <form action="#" id="formPengajuan" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="control-label col-md-12">User Pemakai</label>
                                <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="keterangan" placeholder="Deskripsi" class="form-control inform" type="text" style="text-transform:uppercase;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/capital/administration/pengajuan_persetujuan.js') ?>"></script>
