...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('sales/postsales/finalEntrySuratJalan') ?>" method="post" id="formPO">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Surat Jalan</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                        <div class="section-block">
                            <div class="section-header">
                                <i class="fa fa-address-card"></i> Surat Jalan
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>No. Jurnal Surat Jalan</label>
            ...
            <div class="card mt-3 card-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive" style="overflow-x: auto;">
                                <table id="tabsuratjalandtl" class="table table-bordered table-striped" style="width:100%;" cellspacing="0">
                ...
                <div class="card-footer bg-light">
                    <!-- <a href="<?= base_url('sales/postsales/suratjalan') ?>"
                        class="btn btn-default btn-lg">
                        <i class="fa fa-arrow-left mr-2"></i>
                        Kembali
                    </a> -->
                    <a href="<?= base_url('sales/postsales/clearEntrySuratJalan') ?>" 
...
<div class="modal fade" id="modalDetailSuratJalan" tabindex="-1" role="dialog" aria-labelledby="modalDetailSuratJalanLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">

            <!-- HEADER -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="modalDetailSuratJalanLabel">
                    </i> Input Item Detail
                </h5>
            ...
            <form id="formSuratJalanDetail">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="docnodo" id="docnodo"
                ...
                <div class="modal-footer bg-light">
                    <button type="button"
                            ...
                            onclick="saveSuratJalanDetail()">
                        <i class="fa fa-save"></i> Simpan
                    </button>
                    <button type="button"
                            class="btn btn-secondary"
                            data-bs-dismiss="modal"
                            onclick="$('#modalDetailSuratJalan').modal('hide')">
...
<!-- ================= MODAL TAX DETAIL ================= -->
<div class="modal fade" id="modalUpdateSuratJalan" tabindex="-1" role="dialog" aria-labelledby="modalUpdateSuratJalanLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">

            <!-- HEADER -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="modalUpdateSuratJalanLabel">
                    </i> Edit Item Detail
                </h5>
                <button type="button" class="close text-white" data-bs-dismiss="modal">
                    <span>&times;</span>
            ...
            <form id="formSuratJalanUpdate">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="docno" id="docno">
                    <input type="hidden" name="docnodo" id="docnodo">
                    <!-- <input type="hidden" name="status" id="status" value="P">-->
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>No. Delivery Order</label>
                                <input name="docnodomodal" id="docnodomodal"
                                        class="form-control"
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="button"
                            class="btn btn-secondary"
                            data-bs-dismiss="modal"
                            onclick="$('#modalUpdateSuratJalan').modal('hide')">
                        <i class="fa fa-times"></i> Batal
                    </button>
                </div>
            </form>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/postsales/suratjalan/suratjalan.js') ?>"></script>
