    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1 class="m-0"> Sales Order External</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="card card-cyan card-tabs">
            ...
            <div class="card-body">
                <div class="card-header">
                    <a href="<?= base_url('sales/postsales/addSalesOrderExternal') ?>" class="btn btn-primary" style="margin:0px"><i class="fa fa-plus"></i>  Input Sales Order External  </a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body table-responsive" style='overflow-x:scroll;'>
                                    <table id="t_salesorderexternal" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/postsales/salesorderexternal/salesorderexternal.js') ?>"></script>
