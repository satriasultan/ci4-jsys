                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>No. Surat Jalan</label>
                                <input name="docnosjmodal" id="docnosjmodal"
                                        class="form-control"
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/postsales/deliveryorder/deliveryorder_detail.js') ?>"></script>
