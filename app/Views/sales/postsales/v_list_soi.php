    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1 class="m-0"> Surat Order Internal</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="card card-cyan card-tabs">
            ...
            <div class="card-body">
                <div class="card-header">
                    <a href="<?= base_url('sales/postsales/addSOI') ?>" class="btn btn-primary" style="margin:0px"><i class="fa fa-plus"></i>  Input SOI  </a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body table-responsive" style='overflow-x:scroll;'>
                                    <table id="t_soi" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><div style="vertical-align: middle;" class="text-center text-wrap width-70"> Sales Order/PO</div></th>
                                                <th><div style="vertical-align: middle;" class="text-center text-wrap width-60"> PO Customer </div></th>
                                                <th><div style="vertical-align: middle;" class="text-center text-wrap width-50"> Rev No. </div></th>
                                                <th><div style="vertical-align: middle;" class="text-center text-wrap width-70"> Remark </div></th>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/postsales/soi.js') ?>"></script>
