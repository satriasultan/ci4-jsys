                ...
                <div class="tab-content" id="soTabContent">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive"  style='overflow-x:auto;'>
                                    <table id="tablesalesorderTrx" class="table table-bordered table-striped"  style="width:100%;" cellspacing="0">
                    ...
                    <div class="tab-pane fade" id="pending-content" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive"  style='overflow-x:auto;'>
                                    <table id="tablesalesorderapprvTrx" class="table table-bordered table-striped"  style="width:100%;" cellspacing="0">
                                        <thead class="text-center">
                                            <tr>
                                                <th style="min-width:10px; text-align:center; vertical-align:middle;">No.</th>
                                                <th style="min-width:10px; text-align:center; vertical-align:middle;">Action</th>
