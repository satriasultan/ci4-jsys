...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Informasi Umum Surat Order Internal</h3>
    </div>
    <form  id="soiForm">
        <div class="card-body">
            <div class="row align-items-start"> 
                ...
                <div class="form-group col-md-2">
                    <label for="docdate">Tanggal Dokumen/Periode <span style="color: red;">*</span></label>
        ...
        <?php if (empty($dtldata)) { ?>
            <div class="card-footer">
                <span class="float-left" style="color: red;">Klik button proses terlebih dahulu untuk melanjutkan pengisian item Surat Order Internal</span>
                <button type="submit" onclick="submitSOI()" class="btn btn-primary float-right"><i class="fa fa-repeat"></i> Proses</button>
            </div>
        <?php } ?>
    </form>
</div>  
    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group  col-md-4">
                <label for="po">Sales Order/PO <span style="color: red;">*</span></label>
                    <select class="form-control" id="po" name="po"></select>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="cust">Customer/Destination</label>
                    <input type="text" class="form-control" id="cust"  name="cust"  placeholder="Write Cust" style="text-transform: uppercase;"  disabled>
                </div>
            </div>
            <div class="form-group  col-md-4">
                <label for="pocust">Ref/PO Customer <span style="color: red;">*</span></label>
            ...
            <div class="form-group  col-md-4">
                <label for="revno">No. Rev <span style="color: red;">*</span></label>
                    <input type="text" class="form-control" id="revno"  name="revno"  placeholder="Write Rev No." style="text-transform: uppercase;"  required>
            </div>
            <div class="col-md-3">
                <div class="form-group">
...
<div class="card card-primary" id="detailItem">
    <div class="card-header">
        <h3 class="card-title">Detail Item Surat Order Internal</h3>
    </div>
    <div class="card-body">
        ...
        <div class="row" id="updateSection">
            ...
            <div class="form-group col-md-2">
                <div class="input-group">
                        ...
                        <!-- <button type="button" id="btn_insert_" onclick="insertNewSOI()" class="btn btn-success form-control btn-insert-new float-right"><i class="fa fa-plus"></i> Insert Detail Item</button> -->
                        <button type="button" id="btn_load_" onclick="loadItemSO()" class="btn btn-warning form-control btn-load-new float-right"><i class="fa fa-refresh"></i> Load Item Sales Order</button>
            ...
            <div class="col-sm-12">
                <form id="frm-example" action="#" method="POST">
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table id="t_soi_dtl" class="table table-bordered table-striped"  style="text-wrap:nowrap"  cellspacing="0" >
                            <thead>
                            <tr>
    ...
    <div class="card-footer">
        <a href="<?= base_url('sales/postsales/clearEntrySOI') ?>" 
            onclick="return confirm('This data will not save, are u sure?')" 
            class="btn btn-default float-left">
            <i class="fa fa-arrow-left"></i> Back
        </a>

        <button type="submit"  onclick="finalEntrySOI()" class="btn btn-success float-right">
...
<!-- <div class="card card-primary">
    ...
    <form action="<?= base_url('sales/postsales/finalEntrySOI') ?>" method="post" onsubmit="return confirm('Finish Entry?')">
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-2">
...
<!-- /.modal -->
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/postsales/add_soi.js') ?>"></script>
