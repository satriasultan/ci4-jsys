        ...
        <div class="card card-cyan card-tabs">
            ...
            <div class="card-body">
                <div class="card-header">
                    <a href="<?= base_url('sales/presales/addProforma') ?>" class="btn btn-primary" style="margin:0px"><i class="fa fa-plus"></i>  Input Proforma Invoice  </a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body table-responsive" style='overflow-x:scroll;'>
                                    <table id="t_proforma" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><div style="vertical-align: middle;" class="text-center text-wrap width-30"> Jenis Invoice </div></th>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/presales/proforma.js') ?>"></script>
