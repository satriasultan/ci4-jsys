...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Informasi Umum Proforma Invoice</h3>
    </div>
    ...
    <div class="card-body">
        <div class="row align-items-start"> 
            ...
            <div class="form-group col-md-2">
                <label for="jnsinvoice">Jenis Invoice <span style="color:red">*</span> </label>
                <select name="jnsinvoice" id="jnsinvoice" class="form-control">
                    <option value="" selected disabled>- Choose Jenis -</option>
            ...
            <div class="col-md-3 d-flex mt-4">
                <div class="form-group me-1" style="flex:1.5;">
                    <input type="text" name="prefix" id="prefix" class="form-control" readonly>
                </div>
                <span class="px-2">/</span>
                <div class="form-group mx-1" style="flex:1;">
                    <input type="text" name="infix" id="infix" style="text-transform: uppercase;" class="form-control" 
                                pattern="[A-Za-z0-9-]+"
                                onkeypress="return validateInfix(event)">                </div>
                <span class="px-2">/</span>
                <div class="form-group ms-1" style="flex:1.5;">
                    <input type="text" name="sufix" id="sufix" class="form-control" readonly>
                </div>
            </div>
            ...
            <div class="form-group col-md-2">
                <label for="up">PIC</label>
                <input type="text" class="form-control" id="up"  name="up"  placeholder="Kontak PIC" style="text-transform: uppercase;"  required readonly>
            </div>
            <div class="form-group col-md-5"></div>
            <div class="form-group  col-md-4">
                <label for="facrisk">For Account & Risk Messers</label>
                    <textarea name="facrisk" id="facrisk" class="form-control" rows="2" placeholder="Write For Account & Risk Messers" style="text-transform: uppercase;" ></textarea>
            </div>
            <div class="form-group  col-md-4">
                <label for="shipper">Shipper</label>
                    <textarea name="shipper" id="shipper" class="form-control" rows="2" placeholder="Write Shipper" style="text-transform: uppercase;" ></textarea>
            </div>
            <div class="form-group  col-md-4">
                <label for="consignee">Consignee</label>
                    <textarea name="consignee" id="consignee" class="form-control" rows="2" placeholder="Write Consignee" style="text-transform: uppercase;" ></textarea>
            </div>
            <div class="form-group  col-md-4">
                <label for="shippingmark">Shipping Mark</label>
                    <textarea name="shippingmark" id="shippingmark" class="form-control" rows="2" placeholder="Write Shipping Mark" style="text-transform: uppercase;" ></textarea>
            </div>
            <div class="form-group  col-md-4">
                <label for="notifyparty">Notify Party</label>
                    <textarea name="notifyparty" id="notifyparty" class="form-control" rows="2" placeholder="Write Notify Party" style="text-transform: uppercase;" ></textarea>
            </div>
            
            <!-- <div class="form-group  col-md-4">
                <label for="desc">Description</label>
                    <textarea name="desc" id="desc" class="form-control" rows="2" placeholder="Write description" style="text-transform: uppercase;" ></textarea>
            </div> -->
        </div>
    </div>
    <?php if (empty($dtldata)) { ?>
        <div class="card-footer">
            <span class="float-left" style="color: red;">Klik button proses terlebih dahulu untuk melanjutkan pengisian item Penawaran</span>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Detail Item Proforma Invoice</h3>
    </div>
    <div class="card-body">
        ...
        <div class="row" id="updateSection">
            ...
            <div class="form-group col-md-2">
                <div class="input-group">
                        ...
                        <button type="button" id="btn_insert_" onclick="insertNewProforma()" class="btn btn-success form-control btn-insert-new float-right"><i class="fa fa-plus"></i> Insert Detail Item</button>
            ...
            <div class="col-sm-12">
                <form id="frm-example" action="#" method="POST">
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table id="t_proforma_dtl" class="table table-bordered table-striped"  style="text-wrap:nowrap"  cellspacing="0" >
                            <thead>
                                <tr>
                                    <th rowspan="2" style="width: 20px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Act</th>
                                    <th rowspan="2" style="width: 150px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Nama Barang</th>
                                    <!-- <th rowspan="2" style="width: 100px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Unit</th> -->
                                    <th colspan="2" style="width: 150px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Quantity</th>
                                    <th rowspan="2" style="width: 150px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Price</th>
                                    <th rowspan="2" style="width: 150px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Amount</th>
                                    <!-- <th rowspan="2" style="width: 100px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">USD/MT</th>
                                    <th rowspan="2" style="width: 200px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Description</th> -->
                                </tr>
                                <tr>
                                    <th style="width: 75px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Weight</th>
                                    <th style="width: 75px;font-weight: bold; background-color: darkgrey;text-align: center; vertical-align: middle">Unit</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td colspan="4" rowspan="7" style="vertical-align:top; background:#f0f0f0; padding:10px;">
                                        <label for="desc" style="font-weight:bold;display: block;">Remarks</label>
                                        <textarea name="desc" id="desc" class="form-control" rows="10" 
                                            placeholder="Write description"
                                            style="text-transform: uppercase; width:100%!important; margin-top:5px;"></textarea>
                                    </td>
                                ...
                                <tr>
                                    <td style="font-weight:bold;">Tax Basis</td>
                                    <td>
                                        <div style="display:flex; align-items:center;">
                                        <span style="font-weight: bold; margin-right:5px;">Rp</span>
                                ...
                                <tr>
                                    <td style="font-weight:bold;">V.A.T (12%)</td>
                                    <td>
                                        <div style="display:flex; align-items:center;">
                                        <span style="font-weight: bold; margin-right:5px;">Rp</span>
                                ...
                                <tr>
                                    <td style="font-weight:bold;">PPh 22
                                ...
                                <tr>
                                    <td class="bg-warning" style="font-weight:bold;">Total</td>
                                    <td class="bg-warning">
                                        <div style="display:flex; align-items:center;">
                                        <span style="font-weight: bold; margin-right:5px;">Rp</span>
...
<div class="card card-primary">
    ...
    <!-- <form action="<?= base_url('sales/presales/finalEntryProforma') ?>" method="post" onsubmit="return confirm('Finish Entry?')"> -->
        <div class="card-body">
            <div class="row">
        ...
        <div class="card-footer">
            <a href="<?= base_url('sales/presales/clearEntryProforma') ?>" 
                onclick="return confirm('This data will not save, are u sure?')" 
                class="btn btn-default float-left">
                <i class="fa fa-arrow-left"></i> Back
            </a>

            <button type="submit"  onclick="finalEntryProforma()" class="btn btn-success float-right">
...
<!--Modal untuk Filter-->
<div class="modal fade" id="insertsikbsp">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form-filter">
                <div class="modal-header">
                    <h4 class="modal-title">Insert Detail SIKBSP</h4>
                ...
                <div class="modal-body">
                    <div class="form-group col-md-12">
                        <div class="input-group">
                            <label for="idunitinsert">Insert Unit</label>
                            <select name="idunitinsert" id="idunitinsert" class="form-control" required>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="namabaranginsert">Insert Item Name</label>
                        <input type="text" maxlength="50" class="form-control" id="namabaranginsert" name="namabaranginsert" style="text-transform: uppercase;" placeholder="Insert Item Name" required>
                        <!-- <select name="idbarang_filter_spec" id="idbarang_filter_spec" class="form-control" required >
                        </select> -->
                    </div>
                    <div class="form-group col-md-12">
                        <label for="qtyinsert">Qty</label>
                        <input min="0" class="form-control" id="qtyinsert"  type="number" step="0.01" name="qtyinsert" placeholder="Insert Quantity" required>
                        <!-- <select name="idbarang_filter_spec" id="idbarang_filter_spec" class="form-control" required >
                        </select> -->
                    </div>
                    <div class="form-group col-md-12">
                        <label for="descriptiondetail">Description</label>
                        <textarea name="descriptiondetail" id="descriptiondetail" style="text-transform: uppercase;" class="form-control" rows="2" placeholder="Write description" ></textarea>
                        <!-- <select name="idbarang_filter_spec" id="idbarang_filter_spec" class="form-control" required >
                        </select> -->
                    </div>
                ...
                <div class="modal-footer ">
                    <button onclick="insert_detail_sikbsp()" class="btn btn-success float-right" style="margin-left:5px"><i class="fa fa-plus-circle"></i> Insert Detail SIKBSP </button>
...
<!-- /.modal -->
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/presales/add_proforma.js') ?>"></script>
<script type="application/javascript">
    ...
    function validateInfix(event) {
        const char = String.fromCharCode(event.which);
        // Hanya allow: huruf (A-Z, a-z), angka (0-9), dan strip (-)
    ...
    // Additional validation on input event to remove any special characters that might paste
    document.getElementById('infix').addEventListener('input', function(e) {
        // Hapus semua karakter kecuali: A-Z, a-z, 0-9, dan -
        this.value = this.value.replace(/[^A-Za-z0-9-]/g, '');
    });

    // Validation on form submit
    document.querySelector('form').addEventListener('submit', function(e) {
        const infixValue = document.getElementById('infix').value;
        if (!/^[A-Za-z0-9-]+$/.test(infixValue)) {
            e.preventDefault();
            alert('Hanya huruf, angka, dan tanda strip (-) yang diperbolehkan untuk bagian infix');
            document.getElementById('infix').focus();
        }
    });
