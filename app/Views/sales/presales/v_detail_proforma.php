...
<div class="card card-primary">
    ...
    <div class="card-body">
        <div class="row align-items-start"> 
            ...
            <!-- Role/Job -->
            <div class="form-group col-md-2">
                <label for="rolejob">Role/Job</label>
            ...
            <div class="col-md-3 d-flex mt-4">
                ...
                <div class="form-group mx-1" style="flex:1;">
                    <input type="text" name="infix" id="infix" class="form-control">
                </div>
                <span class="px-2">/</span>
        ...
        <div class="row" id="updateSection">
            ...
            <!-- <div class="form-group col-md-2">
                <div class="input-group">
                        <button type="button" id="btn_insert_" onclick="insertNewOffering()" class="btn btn-success form-control btn-insert-new float-right"><i class="fa fa-plus"></i> Insert Detail Item</button>
            ...
            <!-- <div class="col-md-4">
                <div class="form-group float-left">
                    ...
                    <small style="color: red; font-style: italic; display: block; margin-top: 5px;">
                        Apabila item yang mau ditawarkan belum ada di list, tambahkan terlebih dahulu melalui button ini
                    </small>
                </div>
            </div> -->
                ...
                <form id="frm-example" action="#" method="POST">
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table id="t_proforma_dtl" class="table table-bordered table-striped"  style="text-wrap:nowrap"  cellspacing="0" >
                            <thead>
                            <tr>
                                <td rowspan="2" style="width: 20px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Act</td>
                                <td rowspan="2" style="width: 150px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Nama Barang</td>
                                <!-- <td rowspan="2" style="width: 100px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Unit</td> -->
                                <td colspan="2" style="width: 150px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Quantity</td>
                                <td rowspan="2" style="width: 150px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Price</td>
                                <td rowspan="2" style="width: 150px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Amount</td>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="4" rowspan="7" style="vertical-align:top; background:#f0f0f0; padding:10px;">
                                        <label for="desc" style="font-weight:bold;">Remarks</label>
...
<div class="card card-primary">
    ...
    <form action="<?= base_url('sales/presales/finalEntryProforma') ?>" method="post" onsubmit="return confirm('Finish Entry?')">
            ...
            <div class="row">
                <div class="form-group col-md-2">
                    ...
                    <select class="form-control" id="bank" name="bank" 
                        <?= (empty($dtldata)) ? 'disabled' : '' ?> required>
                    </select>
                </div>
        ...
        <div class="card-footer">
            <a href="<?= base_url('sales/presales/performainvoice') ?>" 
...
<!-- /.modal -->
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/presales/detail_proforma.js') ?>"></script>
