...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Informasi Umum Penawaran Harga</h3>
    </div>
    <form  action="<?php echo base_url('sales/presales/saveOffering')?>" method="post" id="formsaveMstMRP" enctype="multipart/form-data" role="form">
    <div class="card-body">
            ...
            <div class="col-sm-12">
                <form id="frm-example" action="#" method="POST">
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table id="t_offering_dtl" class="table table-bordered table-striped"  style="text-wrap:nowrap"  cellspacing="0" >
                            <thead>
                            <tr>
                                <td style="width: 20px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Act</td>
                                <td style="width: 250px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Nama Barang</td>
                                <td style="width: 100px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Unit</td>
                                <td style="width: 50px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Qty</td>
                                <td style="width: 100px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Price</td>
                                <td style="width: 100px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Exchange Rate</td>
                                <td style="width: 100px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">USD/MT</td>
                                <td style="width: 200px;font-weight: bolder; background-color: darkgrey;text-align: center; vertical-align: middle">Description</td>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<div class="card card-primary">
    ...
    <form action="<?= base_url('sales/presales/finalEntryOffering') ?>" method="post" onsubmit="return confirm('Finish Entry?')">
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-2">
        ...
        <div class="card-footer">
            <a href="<?= base_url('sales/presales/clearEntryOffering') ?>" 
...
<!-- /.modal -->
<script type="application/javascript" src="<?= base_url('assets/pagejs/sales/presales/add_offering.js') ?>"></script>
