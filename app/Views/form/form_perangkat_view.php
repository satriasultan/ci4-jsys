    ...
    <div class="col-md-12">
        <div class="card-primary">
            <div class="card-header">
                <h3 class="card-title">
                    Form Izin Membawa Perangkat IT Pribadi ke Dalam Perusahaan
                </h3>
            </div>
            ...
            <div class="card-body" style="background-color: #e2e2f9;">
                ...
                <div class="section-block">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4">
                            <label><strong>Periode Mulai Penggunaan di Perusahaan</strong></label>
                            <div><?= esc(trim($form->periodemulai ?? '')) ?></div>
                        </div>
                        <div class="col-md-4">
                            <label><strong>Periode Akhir Penggunaan di Perusahaan</strong></label>
