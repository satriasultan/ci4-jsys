    ...
    <div class="col-md-12">
        <div class="card-primary">
            <div class="card-header">
                <h3 class="card-title">
                    Form Izin Membawa Perangkat IT Keluar Dari Perusahaan
                </h3>
            </div>
            ...
            <div class="card-body" style="background-color: #e2e2f9;">
                ...
                <div class="section-block">
                    <div class="section-header">
                        <i class="fa fa-info-circle"></i> Informasi Perangkat
                    </div>
                    <?php if (trim($status) === 'OPEN'): ?>
                    <div class="row mb-2">
                        <div class="col-md-4">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4">
                            <label><strong>Jenis Perangkat</strong></label>
                            <div><?= esc(trim($form->jnsperangkat ?? '')) ?></div>
                        </div>
                        <div class="col-md-4">
                            <label><strong>Merek</strong></label>
                            <div><?= esc(trim($form->merk ?? '')) ?></div>
                        </div>
                    </div>
        
                    <div class="row mb-2">
                        <div class="col-md-4">
                            <label><strong>Periode perangkat dibawa keluar dari Perusahaan</strong></label>
                            <div><?= esc(trim($form->periodemulai ?? '')) ?></div>
                        </div>
                        <div class="col-md-4">
                            <label><strong>Periode perangkat dibawa kembali ke Perusahaan</strong></label>
                            <div><?= esc(trim($form->periodeakhir ?? '')) ?></div>
                        </div>
                    </div>
                    <?php else: ?>
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <div class="alert alert-warning text-center mb-0" style="font-size:12px;">
                                ...
                                sehingga informasi perangkat tidak dapat kami muat. Silahkan menghubungi departemen IT PT Jatim Taman Steel, MFG
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
