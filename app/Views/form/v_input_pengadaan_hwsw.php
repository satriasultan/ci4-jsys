    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Form Pengadaan Hardware dan Software</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('#')?>" method="post" id="formInputReqIT" enctype="multipart/form-data" role="form">
                <div class="card-body" style="background-color: #e2e2f9;">
                    <div class="section-block">
                        <div class="section-header">
                            <i class="fa fa-address-card"></i> Informasi Pengadaan
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" style="text-transform: uppercase;" name="docno" id="docno"  class="form-control" value="<?php echo $docno; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Nama/PIC <span style="color:red">*</span></label>
                                    <input type="text" style="text-transform: uppercase;" name="namapic" id="namapic" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Departemen <span style="color:red">*</span></label>
                                    <input type="text" style="text-transform: uppercase;" name="departemen" id="departemen" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Nama Barang <span style="color:red">*</span></label>
                                    <input type="text" style="text-transform: uppercase;" name="nmbarang" id="nmbarang" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Tanggal Permintaan <span style="color:red">*</span></label>
                                    <input type="text" style="text-transform: uppercase;" name="docdate" id="docdate" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Jumlah Barang <span style="color:red">*</span></label>
                                    <input type="text" style="text-transform: uppercase;" name="jumlah" id="jumlah" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Estimasi Harga/Unit</label>
                                    <input type="text" style="text-transform: uppercase;" name="estimasi" id="estimasi" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Jenis Barang <span style="color:red">*</span></label>
                                    <select name="jnsbarang" id="jnsbarang" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="tujuan" id="tujuan" style="text-transform: uppercase;"  class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Frekuensi Pemakaian <span style="color:red">*</span></label>
                                    <input type="text" style="text-transform: uppercase;"  name="frekuensi" id="frekuensi" class="form-control">Jam/Hari
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Jenis Pengadaan <span style="color:red">*</span></label>
                                    <select name="jnspengadaan" id="jnspengadaan" class="form-control">
                                        <option value="">--Pilih--</option>
                                ...
                                <div class="form-group">
                                    <select name="klasifikasi" id="klasifikasi" class="form-control">
                                        <option value="">--Pilih--</option>
                                        <option value="PERIPHERAL">IT Peripheral (Budget / Unbudget)</option>
                                        <option value="SPAREPART">Spare Part (Budget / Unbudget)</option>
                                        <option value="CONSUMABLE">Consumable</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <textarea name="spesifikasi" id="spesifikasi" style="text-transform: uppercase;" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="lampiran" id="lampiran" class="form-control">
                                        <option value="">--Pilih--</option>
                                        <option value="BOOKLET">Booklet / Brosur dari Supplier</option>
                                        <option value="FOTO">Foto Barang</option>
                    ...
                    <div class="section-block">
                        <div class="section-header">
                            <i class="fa fa-check"></i> Informasi Persetujuan
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Disetujui / Ditolak<small style="color:red">(Diisi oleh IT)</small></label>
                                    <select name="setuju" id="setuju"  class="form-control" <?= $disabled?>>
                                        <option value="">--Pilih--</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Alasan jika ditolak<small style="color:red">(Diisi oleh IT)</small></label>
                                    <textarea name="alasanreject" id="alasanreject" style="text-transform: uppercase;" class="form-control" <?= $disabled?> rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tglpemeriksaan" class="form-control" id="tglpemeriksaan" placeholder="Tanggal Pemeriksaan">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="tglpenyerahan">Tanggal Penyerahan Perangkat</label>
                                    <input type="text" name="tglpenyerahan" class="form-control" id="tglpenyerahan" placeholder="Tanggal Penyerahan Perangkat">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tglpengembalian" class="form-control" id="tglpengembalian" placeholder="Tanggal Pengembalian">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('form/pa/pengadaan_hwsw') ?>" class="btn btn-default">Kembali</a>
                    <button id="btnSave" onclick="saveInputReqIT();" class="btn btn-primary float-right">Submit</button>
                </div>
            </form>
        </div>
        <!-- /.card -->
