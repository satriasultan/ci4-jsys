...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form action="<?php echo site_url('trans/shareloc/proses_xls_shareloc')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <a href="<?= base_url('assets/files/shareloc/example/shareloc_template.xlsx') ?>" class="btn btn-default"><i class="fa fa-file-excel-o"></i> Download Template </a>
                    <?php if ($adaisi>0) { ?>
                    <a href="<?= base_url('trans/shareloc/clear_tmp') ?>" class="btn btn-danger pull-right"><i class="fa fa-trash-o"></i> Clear Data </a>
                    <a href="<?= base_url('trans/shareloc/final_data') ?>" class="btn btn-primary pull-right"><i class="fa fa-sign-in"></i> Final Data </a>
                    <?php } ?>
                </div>
            </form>
        </div><!-- /.box -->
		...
		<div class="box">
			...
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						<?php $no=0; foreach($list_shareloc as $lu): $no++;?>
						<tr>
							...
							<td width="5%" class="ratakanan"><?php echo $lu->attenddate1;?></td>
							<td><?php echo trim($lu->attend);?></td>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Periode shareloc</h4>
      </div>
	  <form action="<?php echo site_url('trans/shareloc/index')?>" method="post">
...
<script type="text/javascript" src="<?= base_url('assets/pagejs/trans/shareloc.js') ?>"></script>
