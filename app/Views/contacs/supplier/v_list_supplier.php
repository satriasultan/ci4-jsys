    ...
    <div class="card-header">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <!--a class="dropdown-item" href="#"  onclick="add_msupplier()"><i class="fa fa-plus" ></i><?php echo '     Input'; ?> </a-->

                <a class="dropdown-item" href="<?php echo base_url('/contacts/supplier/input_supplier') ?>" ><i class="fa fa-plus"></i><?php echo ' Input Supplier'; ?> </a>
                <a class="dropdown-item" href="#"  onclick="reload_table()"><i class="fa fa-refresh"></i><?php echo '    Reload'; ?> </a>
            </div>
        </div>
    </div><!-- /.card-header -->
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmsupplier" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <div class="col-md-12">
                                    <input name="idsupplier" placeholder="ID Supplier" class="form-control inform" type="text" MAXLENGTH="20" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <div class="col-md-12">
                                    <input name="contact1" placeholder="Contact 1" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="form-group col-lg-4">
                                ...
                                <div class="col-md-12">
                                    <input name="contact2" placeholder="Contact 2" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="form-group col-lg-4">
                                ...
                                <div class="col-md-12">
                                    <input name="email" placeholder="Email Address Supplier" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label class="control-label col-md-12">Address Supplier</label>
                                <div class="col-md-12">
                                    <input name="addsupplier" placeholder="Address Supplier" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="form-group col-lg-4">
