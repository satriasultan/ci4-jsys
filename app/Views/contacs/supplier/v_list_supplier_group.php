...
<div class="card">
    ...
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmsupplier_group" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="idsupplier" placeholder="ID Supplier" class="form-control inform" type="text" MAXLENGTH="20" style="text-transform:uppercase;" required>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Owner Supplier</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Address Supplier</label>
                            <div class="col-md-12">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/contacs/msupplier_group.js') ?>"></script>
