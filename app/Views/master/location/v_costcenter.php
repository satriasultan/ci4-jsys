...
<div class="card">
    ...
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmcostcenter" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/master/mcostcenter.js') ?>"></script>
