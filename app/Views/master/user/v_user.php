<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            ...
            <div class="col-sm-6">
                <h1 class="m-0">
                    <?= ucwords(strtolower(trim($x['namamenu']))); ?>
                </h1>
            </div>
                                ...
                                <div>
                                    <select class="form-control input-sm" name="loccode" id="loccode">
                                        <?php foreach($list_gudang as $lg){?>
                                            <option value="<?php echo trim($lg->idlocation);?>" ><?php echo $lg->idlocation.' || '.$lg->nmlocation;?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div>
                                    <select class="form-control input-sm" name="roleid" id="roleid">
                                        <?php foreach($list_role as $lrl){?>
                                            <option value="<?php echo trim($lrl->roleid);?>" ><?php echo $lrl->roleid.' || '.$lrl->rolename;?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
