			...
			<div class="card-header">
                <div class="row">
                    <div class="col-md-12 offset-md-0">
                        <form action="<?php echo base_url('/master/item/batch')?>" method="get">
                                <div class="form-horizontal">
                                    <div class="row">
                                    <div class="form-group col-md-3">
                                        <div>
                                            <select class="form-control input-sm"  id="idlocation" name="idlocation" class="col-sm-12">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <button type="submit"  class="btn btn-primary"><i class="fa fa-search"></i> Buka Gudang</button>
                                    </div>
                    ...
                    <div class="col-md-12 offset-md-0">
                        <div class="input-group">
                            <?php if (trim($dtllocation['idlocation'] ?? null) !== '') { ?>
                            <button href="#" id="delete_batch" class="btn btn-danger float-left" style="margin: 10px;"><i class="fa fa-trash"></i> Hapus </button>
                            <!--button href="#" id="update_batch" class="btn btn-warning float-left"  style="margin: 10px;"><i class="fa fa-gear"></i> Ubah </button-->
                            <?php } ?>
                            <input type="hidden" id="idlocation_get" name="idlocation_get" value="<?php echo trim($dtllocation['idlocation'] ?? null) ?>">
                            <input type="search" id="searchitem"  style="margin: 10px;" class="form-control form-control-md offset-md-2" placeholder="Scan search your item barcode or rack/area" <?php if (trim($dtllocation['idlocation'] ?? null) !== '') { echo ''; } else { echo 'disabled'; } ?>>
                            <span class="help-block"></span>
                            <button  onclick="open_scan();" class="btn btn-md btn-primary float-left"  style="margin: 10px;"  <?php if (trim($dtllocation['idlocation'] ?? null) !== '') { echo ''; } else { echo 'disabled'; } ?>><i class="fa fa-barcode"></i></button>
                        </div>
                    </div>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/master/item_list_batch.js') ?>"></script>
