        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 ">
                        <a href="<?php echo base_url('master/item/clearTemporaryPrinter') ?>" class="btn btn-danger float-left"><i class="fa fa-trash"></i> Clear All</a>
                        <a href="<?php echo base_url('master/item/printFromListPrinter') ?>"  class="btn btn-success float-right"><i class="fa fa-print"></i> Print K.stock</a>
                        <a href="<?php echo base_url('master/item/printFromListPrinterRackMode') ?>"  class="btn btn-primary float-right"><i class="fa fa-print"></i> Print Rack</a>
                    </div>
                </div>
            </div><!-- /.card-header -->
