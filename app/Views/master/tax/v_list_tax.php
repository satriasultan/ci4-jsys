	...
	<div class="col-sm-12">
		<div class="card">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($dtl_akses['a_input']) && trim($dtl_akses['a_input']) === 't'): ?>
                            <a class="dropdown-item" href="<?= base_url('master/data/input_tax') ?>"><i class="fa fa-plus"></i><?php echo '   Input'; ?> </a>
                        <?php endif; ?>
			...
			<div class="card-body table-responsive m-t-40" style='overflow-x:scroll;' cellspacing="0" width="100%">
				<table id="t_tax" class="table table-bordered table-striped" >
					<thead class="text-center">
						<tr>
                            ...
                            <th style="min-width:100px; text-align:center; vertical-align:middle;">ID Tax</th>
                            <th style="min-width:200px; text-align:center; vertical-align:middle;">Nama Tax</th>
                            <th style="min-width:250px; text-align:center; vertical-align:middle;">Hold</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
