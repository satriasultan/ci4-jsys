...
<div class="card">
    <div class="card-header">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"  onclick="add_principal()"><i class="fa fa-plus" ></i><?php echo '     Input'; ?> </a>
                <?php endif;?>
    ...
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmprincipal" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <label class="">Kode Jenis</label>
                                    <input name="idprincipal" placeholder="Kode Jenis" class="form-control inform" type="text" MAXLENGTH="10" style="text-transform:uppercase;" required>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                <label class="">Nama Principal</label>
                                    <input name="nmprincipal" placeholder="Nama Principal" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                <label class="">Kode Reff Supplier</label>
                                    <select name="kdsupplier" id="kdsupplier" class="form-control inform"></select>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <label class="">Alamat</label>
                                    <textarea name="alamat" disabled id="alamat" placeholder="Alamat" row="3" class="form-control" type="text" style="text-transform:uppercase;"></textarea>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <label class="">Telepon</label>
                                    <input name="phone" disabled id="phone" placeholder="phone" class="form-control" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/master/principal/principal.js') ?>"></script>
