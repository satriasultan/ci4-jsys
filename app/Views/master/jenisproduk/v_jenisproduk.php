...
<div class="card">
    <div class="card-header">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"  onclick="add_jenisproduk()"><i class="fa fa-plus" ></i><?php echo '     Input'; ?> </a>
                <?php endif;?>
    ...
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmjenisproduk" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <label class="">Kode Jenis</label>
                                    <input name="idjenisproduk" placeholder="Kode Jenis" class="form-control inform" type="text" MAXLENGTH="10" style="text-transform:uppercase;" required>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                <label class="">Nama Jenis Produk</label>
                                    <input name="nmjenisproduk" placeholder="Nama Jenis Produk" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/master/jenisproduk/jenisproduk.js') ?>"></script>
