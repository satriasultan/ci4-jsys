            ...
            <div class="card-header">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#"  onclick="refreshJobTree()"><i class="fa fa-refresh"></i><?php echo '    Reload'; ?> </a>
                    </div>
                </div>
            </div><!-- /.card-header -->
                    ...
                    <div class="form-group">
                        <!-- <div class="col-md-3">
                            <div class="alert alert-info">
                                Double click salah satu Job untuk melihat detail
                            </div>
                        </div> -->
                        <div class="col-md-6">
                            <input style="background-color: #a1ccff" type="text" id="key" value="" class="empty form-control" placeholder="Ketik Untuk Mencari Nama Job"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="section-block">
                            <div class="section-header">
                                <i class="fa fa-pie-chart"></i> List Branch/Job
                            </div>
                            <hr>
...
<script type="text/javascript">
        ...
        function initCustomerSelect2() {
            ...
            $('#idcustomer').select2({
                ...
                ajax: {
                    ...
                    //             id: item.idcustomer,
                    //             kdcustomer: item.kdcustomer,
                    //             nmcustomer: item.nmcustomer
                    //         }))
                    //     };
                    // }
            ...
            // 🔴 INI KUNCI UTAMA
            $('[name="alamatcust"]').val(data.alamat_kantor ?? '');
        ...
        function initIdcustByAjax() {

            let idcustomer = $('#job_idcust').val();
            if (!idcustomer) return;

            $.ajax({
                type: 'GET',
                url: HOST_URL + 'api/globalmodule/list_customer?var=' + idcustomer,
                dataType: 'json'
            }).then(function (res) {
                ...
                $('#idcustomer').append(option).trigger('change');
        ...
        function onNodeDblClick(event, treeId, treeNode) {
            ...
            // Swal.fire({
            //     title: 'Detail Job',
            //     text: 'Melihat detail Job: ' + node.text,
            //     icon: 'info'
            // });
