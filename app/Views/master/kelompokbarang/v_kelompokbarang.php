...
<div class="card">
    <div class="card-header">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"  onclick="add_kelompokbarang()"><i class="fa fa-plus" ></i><?php echo '     Input'; ?> </a>
                <?php endif;?>
    ...
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmkelompokbarang" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <label class="">Kode</label>
                                    <input name="idkelompokbarang" placeholder="Kode" class="form-control inform" type="text" MAXLENGTH="10" style="text-transform:uppercase;" required>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                <label class="">Nama Kelompok Barang</label>
                                    <input name="nmkelompokbarang" placeholder="Nama Kelompok Barang" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/master/kelompokbarang/kelompokbarang.js') ?>"></script>
