...
<div class="card">
    <div class="card-header">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"  onclick="add_golonganbarang()"><i class="fa fa-plus" ></i><?php echo '     Input'; ?> </a>
                <?php endif;?>
    ...
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmgolonganbarang" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
                <th width="8%">Action</th>
                <th>Kode Golongan</th>
                <th>Nama Golongan Barang</th>
                <th>Hold</th>
            </tr>
            </thead>
            <tbody>
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <label class="">Kode Gol</label>
                                    <input name="idgolonganbarang" placeholder="Kode Gol" class="form-control inform" type="text" MAXLENGTH="10" style="text-transform:uppercase;" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <label class="">Nama Golongan</label>
                                    <input name="nmgolonganbarang" placeholder="Nama Golongan" class="form-control inform" type="text" style="text-transform:uppercase;">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/master/golonganbarang/golonganbarang.js') ?>"></script>
