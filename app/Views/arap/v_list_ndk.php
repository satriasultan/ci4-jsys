                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($dtl_akses['a_input']) && trim($dtl_akses['a_input']) === 't'): ?>
                            <a class="dropdown-item" href="<?= base_url('arap/transaksi/addNDK') ?>"><i class="fa fa-plus"></i><?php echo '   Input'; ?> </a>
                        <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive"  style='overflow-x:auto;'>
                            <table id="tablendkTrx" class="table table-bordered table-striped"  style="width:100%;" cellspacing="0">
