	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-header">
                <h7 class="text-center display-6"><?php echo $title ?></h7>
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            */ ?>
                            <!--input type="text" id="searchitem" style="font-weight: bolder" class="form-control form-control-md" placeholder="Cari Item Name" -->
                            <div class="input-group">
                                <select name="cariitem[]" id="cariitem" class="form-control" required >
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body">
               <div class="row appendframe">
                   <iframe id="inlineframe"
                           title="Frame Report"
                           width="100%"
                           height="690px"
                           src="<?php echo base_url().'/stock/balance/show_sti_allocation_map?docno='; ?>">
                   </iframe>
               </div>
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/stock/balance_allocation_map.js') ?>"></script>
