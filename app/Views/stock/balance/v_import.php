...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <form action="<?php echo base_url('stock/balance/proses_upload')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('assets/files/item/example/import_opening_stock_example.xlsx') ?>" class="btn btn-default  btn-sm"><i class="fa fa-file-excel-o"></i> Download Template </a>
                    <?php if ($adaisi>0) { ?>
                        <a href="<?= base_url('stock/balance/clear_tmp') ?>" class="btn btn-danger btn-sm float-right"><i class="fa fa-trash-o"></i> Clear Data </a>
                        <a href="<?= base_url('stock/balance/final_data') ?>" class="btn btn-primary btn-sm  float-right"><i class="fa fa-sign-in"></i> Final Data </a>
                    <?php } ?>
                </div>
            </form>
        </div><!-- /.card -->
                ...
                <table id="example1" class="table table-bordered table-striped" >
                    ...
                    <?php $no=0; foreach($list_detail as $lu): $no++;?>
                        <tr>
                            ...
                            <td><?php echo $lu->nmbarang_asal;?></td>
