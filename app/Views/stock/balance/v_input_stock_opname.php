<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><?php echo ucwords(strtolower(trim($x['namamenu']))).' '.$dateOpname;?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <!-- form start -->
                ...
                <div class="card-body row">
                    <div class="col-md-8 offset-md-2">
                        <div class="input-group">
                            ...
                            <input type="hidden" id="dateOpname" class="form-control form-control-md" value="<?php echo $dateOpname;?>">
                ...
                <div class="card-body row table-responsive" style='overflow-x:scroll;'>
                    ...
                    <tr>
                        ...
                        <th>Nama Barang</th>
                        <th>Spesifikasi</th>
                        <th>Stok (<?php echo date('Y/m/d');?>)</th>
                        <th>Unit</th>
                        <th>Area</th>
                        <th>Category</th>
                        <th>Item ID</th>
                ...
                <div class="card-footer">
                    <a href="<?= base_url('stock/balance/stockopname') ?>" class="btn btn-default"><i class="fa fa-arrow-left"></i>Kembali</a>
                   <?php /*
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <form action="#" id="form" method="post" enctype="multipart/form-data" role="form" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="hidden" name="datenow" value="<?php echo date('d-m-Y'); ?>" >
                    ...
                    <div class="form-group row">
                        ...
                        <label class="control-label col-md-1">Tanggal SO</label>
                        <div class="col-md-4">
                            <input type="text" name="trxdate" class="form-control" id="trxdate" placeholder="Tanggal SO">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-2">Qty <?php echo $dateOpname;?></label>
                        <div class="col-md-7">
                            <input name="qty" placeholder="Qty Fisik" class="form-control inform ratakanan" type="text"  style="text-transform:uppercase;">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-2">Area / Rack</label>
                        <div class="col-md-10">
                            <input name="nmarea" placeholder="AREA NAME" class="form-control inform" type="text" style="text-transform:uppercase;">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-2">Area Pindah SO</label>
                        <div class="col-md-10">
                            <select name="idareaso" id="idareaso" class="form-control"  >
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-2">Qty Fisik</label>
                        <div class="col-md-7">
                            <input name="qtyso" placeholder="Qty Fisik" class="form-control inform ratakanan" type="text" MAXLENGTH="20" style="text-transform:uppercase;">
                        </div>
                        <div class="col-md-3">
                            <input name="unitso" placeholder="Item unit" class="form-control inform ratakanan" type="text" style="text-transform:uppercase;">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-2">Pilih Barang Untuk SO Reclass</label>
                        <div class="col-md-10">
                            <select name="idbarangso" id="idbarangso" class="form-control"  >
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select name="batchnew" id="batchnew" class="form-control">
                            </select>
                        </div>
                        <div class="col-md-2">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="saveOpnameStock()" class="btn btn-primary">Save</button>
