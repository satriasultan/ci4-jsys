...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('stock/balance/verifikasi_mst_stock_ajustment')?>" method="post" id="formInputTransfers" enctype="multipart/form-data" role="form">
                <div class="card-body row">
                    <div class="row col-sm-5">
                        <div class="form-group col-sm-12 ">
                            <label for="idlocation">Choose Your Type Ajustment</label>
                            <div class="input-group">
                                <select name="doctype" id="doctype" class="form-control" required <?php if (trim($dtldata['status']) !== 'I') { echo 'disabled'; } ?>  required>
                                    <option value=""> Choose Your Ajustment Type </option>
                        ...
                        <div class="form-group col-sm-6 ">
                            <label for="docdate">Ajustment Date</label>
                            <input type="text" name="docdate" class="form-control" id="docdate" placeholder="Ajustment Date" required <?php if (trim($dtldata['status']) !== 'I') { echo 'disabled'; } ?>>
                        </div>
                        <div class="form-group col-sm-12 ">
                            <label for="description">Reference ID</label>
                            <input type="text" name="docref" class="form-control" id="docref" placeholder="Reference ID" <?php if (trim($dtldata['status']) !== 'I') { echo 'disabled'; } ?> required>
                        </div>
                        <div class="form-group col-sm-12 ">
                            <label for="description">Description</label>
                            <input type="text" name="description" class="form-control" id="description" placeholder="Description" <?php if (trim($dtldata['status']) !== 'I') { echo 'disabled'; } ?> required>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style='overflow-x:scroll;'>
                            <table id="talocationajustment" class="table table-bordered table-striped" >
                                <thead>
                                <tr>
                                    <th width="1%">No.</th>
                                    <th width="2%">Action</th>
                ...
                <div class="card-footer">
                    <a href="<?= base_url('stock/balance/clearEntryAjustment') ?>" onclick="return confirm('Are you sure clear this entry?')" class="btn btn-default float-left"><i class="fa fa-arrow-left"></i>Back</a>
                    <a href="<?= base_url('stock/balance/finalEntryAjustment') ?>" onclick="return confirm('Are you sure final this entry?')" class="btn btn-success float-right"><i class="fa fa-arrow-right"></i>Final</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" id="formAddItemajustment" method="post" enctype="multipart/form-data" role="form" >
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save_dtlajustments()" class="btn btn-primary">Save</button>
