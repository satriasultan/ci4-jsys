    ...
    <div class="col-md-6">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"> Laporan Stock Opname Harian </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('stock/report/show_laporan_so')?>" method="post" id="formInputTransfers" enctype="multipart/form-data" role="form">
