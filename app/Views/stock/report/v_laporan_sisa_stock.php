    ...
    <div class="col-md-6">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"> Laporan Sisa Stok Per Gudang </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('stock/report/show_sisastockgdg')?>" method="post" id="formInputTransfers" enctype="multipart/form-data" role="form">
                <div class="card-body row">
                    ...
                    <div class="form-group col-sm-12 ">
                        <label for="idbarang">Using Header Report</label>
                        <div class="row">
                            <div class="form-check col-sm-6" style="margin-left:10px;">
                                <input class="form-check-input" type="radio" name="formheader" value="HEADER" style="height:20px; width:20px; vertical-align: middle;" checked>
                                <label class="form-check-label" style="margin-left:10px;margin-top:5px;">Header</label>
                            </div>
                            <div class="form-check col-sm-5">
                                <input class="form-check-input" type="radio" name="formheader" value="NONHEADER" style="height:20px; width:20px; vertical-align: middle;" >
                                <label class="form-check-label" style="margin-left:10px;margin-top:5px;">Non Header</label>
                            </div>
                        </div>
                    </div>
                    <div class="row col-sm-12">
