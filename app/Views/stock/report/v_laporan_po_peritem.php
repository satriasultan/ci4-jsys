    ...
    <div class="col-md-6">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"> Laporan Analisa PO Per Kedatangan Barang</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('stock/report/show_po_peritem')?>" method="post" id="formInputTransfers" enctype="multipart/form-data" role="form">
                <div class="card-body row">
                    <div class="row col-sm-12">
                        <div class="form-group col-sm-12 ">
                            <label for="docno">Date (Tanggal Pembelian/(PO) </label>
