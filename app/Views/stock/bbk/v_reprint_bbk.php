    ...
    <div class="col-md-6">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"> Reprint BBK (Bukti Barang Keluar) </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('stock/bbk/print_stock_bbk')?>" method="post" id="formInputTransfers" enctype="multipart/form-data" role="form">
