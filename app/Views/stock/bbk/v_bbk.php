    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                    <a href="<?= base_url('stock/bbk/input_bbk') ?>" class="btn btn-primary" style="margin:10px"><i class="fa fa-plus"></i>  Input PBL  </a>
            ...
            <div class="card-body table-responsive" style='overflow-x:scroll;'>
                <table id="tablebbkTrx" class="table table-bordered table-striped" >
                    <thead>
                    <tr>
                        <th width="1%">No.</th>
            ...
            <form id="form-filter">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control tglrange" id="tglrange"  name="tglrange" data-date-format="dd-mm-yyyy" required placeholder="Entry PBL Date" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="suppliername">Pilih Costcenter/Bagian</label>
                        <select name="idsection" id="idsection" class="form-control">
                        </select>
                    </div>
                    <div class="form-group">
