    ...
    <div class="card-header">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"  onclick="reloadTlistPblWacc()"><i class="fa fa-refresh"></i><?php echo '    Reload'; ?> </a>
            </div>
        </div>
    </div><!-- /.card-header -->
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tlistpbl_wacc" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th>No.</th>

                <th><div class="text-wrap width-90"> Jurnal </div></th>
                <th><div class="text-wrap width-90"> Batch </div></th>
        ...
        <div class="modal-content">
            <form  action="#"  id="form-filter" >
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" id="btn-reset-wacc" class="btn btn-default">Reset</button>
                    <button type="button" id="btn-filter-wacc" class="btn btn-primary">Filter</button>
