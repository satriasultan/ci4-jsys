                ...
                <form id="formLPBvoid">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <input type="text" name="docnovoid" class="form-control" id="docnovoid" placeholder="Masukan Dokumen PBL Untuk Melakukan Void" required>
                        </div>


                        <div class="form-group col-sm-2 ">
                            <button type="button" id="btnloadbbk" onclick="load_item_bbk_onvoid()" class="btn btn-primary form-control float-right"><i class="fa fa-repeat"></i> Load Item</button>
                        </div>
                        <?php /*
                    <div class="form-group col-sm-2">
                        ...
                        <div class="form-group col-sm-2">
                            <button type="button" id="btnloadbbk" onclick="delete_list_bbk_onvoid()" class="btn btn-danger form-control float-right"><i class="fa fa-repeat"></i> Clear</button>
                        </div>
                        <div class="form-group col-sm-2">
                            <button type="button" onclick="process_bbk_onvoid()"   class="btn btn-success form-control float-right"><i class="fa fa-close"></i> Process Void</button>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save_bbk_onvoid()" class="btn btn-primary">Save</button>
