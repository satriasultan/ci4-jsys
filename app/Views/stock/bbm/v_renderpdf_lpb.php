...
<div class="row">
    <div class="col-12">
        ...
        <h3 class="text-center">Laporan Penerimaan Barang</h3>
    </div>
    <?php /*
    <div class="col-12">
    ...
    <div class="col-12">
        <h5 class="text-left" style="text-align: right; font-size: 20px; width:90%;">DOC NO    : <?= trim($master['docno']) ?></h5>
        <h5 class="text-left" style="text-align: right; font-size: 20px; width:90%;">TANGGAL      : <?= trim($master['docdate1']) ?></h5>
        <h5 class="text-left" style="text-align: right; font-size: 20px; width:90%;">JENIS     : <?= trim($master['docjns']) ?></h5>
        <h5 class="text-left" style="text-align: right; font-size: 20px; width:90%;">REFERENSI    : <?= trim($master['docref']) ?></h5>
        <h5 class="text-left" style="text-align: right; font-size: 20px; width:90%;">SUPPLIER  : <?= ucfirst(trim($master['nmsupplier'])) ?></h5>
        <h5 class="text-left" style="text-align: right; font-size: 20px; width:90%;">KET      : <?= ucfirst(trim($master['description'])) ?></h5>
    </div>
    <div class="col-12 ">
        <table class="table ">
            <thead>
            ...
            <?php $no=0; foreach($detail as $lar): $no++;?>
                <tr>
                    <?php if (trim($lar->urut)==='2') { ?>
                        <td style="text-align: left; font-size: 20px;width:90%"><?php echo $lar->idbarang;?></td>
                    <?php } else { ?>
                        <td style="text-align: left; font-size: 9px;font-weight: bolder;width:90%"><?php echo $lar->idbarang;?></td>
                    <?php } ?>
