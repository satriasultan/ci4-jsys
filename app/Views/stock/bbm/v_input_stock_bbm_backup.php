    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1 class="m-0"> Input BBM (Bukti Barang Masuk)</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card-body row">
                    ...
                    <div class="row col-sm-7" >
                        ...
                        <?php if (trim($dtldata['status']) === 'E') {  ?>
                            <div class="form-group col-sm-12">
                                <div class="input-group" >
                                    <a href="<?= base_url('stock/bbm/load_po_to_bbm') ?>" onclick="return confirm('load from outstanding po entry?')" class="btn btn-success"><i class="fa fa-arrow-right"></i>Load Item Dari PO</a>
                                </div>
                            </div>
                        <?php } ?>
                        <?php /*
