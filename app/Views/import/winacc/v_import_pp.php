...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <form action="<?php echo base_url('import/winacc/proses_upload_pp')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputFile">File Import PP (Winacc)</label>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('assets/files/Purchaseorder/example/import_pp.xlsx') ?>" class="btn btn-default  btn-sm"><i class="fa fa-file-excel-o"></i> Template Import PP</a>
                    <?php /* if ($adaisi>0) {
            ...
            <div class="card-body table-responsive" style='overflow-x:scroll;'>
                <table id="example1" class="table table-bordered table-striped" >
                    ...
                    <?php $no=0; foreach($list_detail as $lu): $no++;?>
                        <tr>
                            <td><div class='text-wrap width-200'><?php echo $lu->pp;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->jurnal;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo date("d-m-Y",strtotime($lu->date_));?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->username;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->brg;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->qty;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->lns;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->gdg;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->nama_user;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->nama_barang;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->unit;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->spec;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->job;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->rem_pp;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->rem_pd;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo date("d-m-Y",strtotime($lu->date_pakai));?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->uniqueidpd;?></div></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
