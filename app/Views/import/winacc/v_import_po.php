...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <form action="<?php echo base_url('import/winacc/proses_upload_po')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('assets/files/Purchaseorder/example/import_po.xlsx') ?>" class="btn btn-default  btn-sm"><i class="fa fa-file-excel-o"></i> Template Import OUTSTANDING PO + HISTORY</a>
                    <?php /* if ($adaisi>0) {
            ...
            <div class="card-body table-responsive" style='overflow-x:scroll;'>
                <table id="example1" class="table table-bordered table-striped" >
                    ...
                    <?php $no=0; foreach($list_detail as $lu): $no++;?>
                        <tr>
                            <td><div class='text-wrap width-200'><?php echo $lu->obl;?></div></td>
                            ...
                            <td><div class='text-wrap width-200'><?php echo $lu->gdgobl;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->qty;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->lns;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->val;?></div></td>
                            ...
                            <td><div class='text-wrap width-200'><?php echo $lu->nama_supplier;?></div></td>
                            ...
                            <td><div class='text-wrap width-200'><?php echo $lu->priceobl;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo $lu->rempd;?></div></td>
                            <td><div class='text-wrap width-200'><?php echo date("d-m-Y",strtotime($lu->tglkirim));?></div></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
