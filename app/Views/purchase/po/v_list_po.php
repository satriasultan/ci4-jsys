                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($dtl_akses['a_input']) && trim($dtl_akses['a_input']) === 't'): ?>
                            <a class="dropdown-item" href="<?= base_url('purchase/trans/addPO') ?>"><i class="fa fa-plus"></i><?php echo '   Input'; ?> </a>
                        <?php endif; ?>
                ...
                <div class="tab-content" id="poTabContent">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive"  style='overflow-x:auto;'>
                                    <table id="tablepoTrx" class="table table-bordered table-striped"  style="width:100%;" cellspacing="0">
                                        <thead class="text-center">
                                            <tr>
                                                ...
                                                <th style="min-width:150px; text-align:center; vertical-align:middle;">Nama Supplier</th>
                    ...
                    <div class="tab-pane fade" id="pending-content" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive"  style='overflow-x:auto;'>
                                    <table id="tablepoapprvTrx" class="table table-bordered table-striped"  style="width:100%;" cellspacing="0">
                                        <thead class="text-center">
                                            <tr>
                                                <th style="min-width:10px; text-align:center; vertical-align:middle;">No.</th>
                                                <th style="min-width:10px; text-align:center; vertical-align:middle;">Action</th>
                                                <th style="min-width:100px; text-align:center; vertical-align:middle;">Docno</th>
                                                <th style="min-width:100px; text-align:center; vertical-align:middle;">Tanggal</th>
                                                <th style="min-width:100px; text-align:center; vertical-align:middle;">Tgl Jatuh Tempo</th>
                                                <th style="min-width:100px; text-align:center; vertical-align:middle;">Tgl Pengiriman</th>
                                                <th style="min-width:400px; text-align:center; vertical-align:middle;">Keterangan</th>
                                                <th style="min-width:50px; text-align:center; vertical-align:middle;">Kode Supplier</th>
                                                <th style="min-width:150px; text-align:center; vertical-align:middle;">Nama Supplier</th>
                                                <th style="min-width:80px; text-align:center; vertical-align:middle;">Status</th>
