...
<div class="card">
    ...
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tlistoutstandingpo" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th>No.</th>
                <th><div class="">Action</div></th>
                <th><div class="text-wrap width-90"> PO Number </div></th>
                <th><div class="text-wrap width-90"> PO Date </div></th>
                <th><div class="text-wrap width-90"> ID Brg </div></th>
                <th><div class="text-wrap width-90"> Nama Brg </div></th>
                <th><div class="text-wrap width-90"> Unit </div></th>
                <th><div class="text-wrap width-90"> Qty PO </div></th>
                <th><div class="text-wrap width-90"> Qty Receive </div></th>
                <th><div class="text-wrap width-90"> Sisa Ost</div></th>
                <th><div class="text-wrap width-90"> Kotor </div></th>
                <th><div class="text-wrap width-90"> Supplier </div></th>
                <th><div class="text-wrap width-150"> Description </div></th>
                <th><div class="text-wrap width-90"> TglKirim </div></th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="tanggalpo">Tanggal Pembelian</label>
                    <input type="text" class="form-control tglrange" id="tglrange"  name="tglrange" data-date-format="dd-mm-yyyy" required placeholder="Entry PO Date" required>
                </div>
                <div class="form-group">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/purchase/purchaseorder.js') ?>"></script>
