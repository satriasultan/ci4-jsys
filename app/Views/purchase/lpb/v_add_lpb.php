...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('purchase/trans/finalEntryLPB') ?>" method="post" id="formPO">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Penerimaan Pembelian</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                        <div class="section-block">
                            <div class="section-header">
                                <i class="fa fa-address-card"></i> Penerimaan Pembelian
                            </div>
                            <div class="row">
            ...
            <div class="card mt-3 card-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive" style="overflow-x: auto;">
                                <table id="tablpbdtl" class="table table-bordered table-striped" style="width:100%;" cellspacing="0">
                ...
                <div class="card-footer bg-light">
                    <a href="<?= base_url('purchase/trans/lpb') ?>"
