                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($dtl_akses['a_input']) && trim($dtl_akses['a_input']) === 't'): ?>
                            <a class="dropdown-item" href="<?= base_url('purchase/trans/addLPB') ?>"><i class="fa fa-plus"></i><?php echo '   Input'; ?> </a>
                        <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive"  style='overflow-x:auto;'>
                            <table id="tablelpbTrx" class="table table-bordered table-striped"  style="width:100%;" cellspacing="0">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th style="min-width:400px; text-align:center; vertical-align:middle;">No. Faktur</th>
                                        <th style="min-width:400px; text-align:center; vertical-align:middle;">No. SJ</th>
