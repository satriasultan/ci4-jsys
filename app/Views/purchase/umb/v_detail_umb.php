...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('purchase/trans/finalEntryUMB') ?>" method="post" id="formPO">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Uang Muka Pembelian</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                        <div class="section-block">
                            <div class="section-header">
                                <i class="fa fa-address-card"></i> Uang Muka Pembelian
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>No. Jurnal Uang Muka Pembelian</label>
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="margin-top: -25px;">
                                            <div class="form-group">
                                                <label for="prkarap">Prk. AR/AP</label>
                ...
                <div class="card-footer bg-light">
                    <a href="<?= base_url('purchase/trans/umb') ?>"
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/purchase/umb_detail.js') ?>"></script>
