...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"> Show Labels Area Position </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('master/location/show_showlabels_area')?>" method="post" id="formInputTransfers" enctype="multipart/form-data" role="form">
    ...
    <div class="col-md-6">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"> Show Labels Area Position Partial</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form  action="<?php echo base_url('master/location/show_showlabels_area_partial')?>" method="post" id="formInputTransfers" enctype="multipart/form-data" role="form">
                <div class="card-body row">
                    <div class="form-group col-sm-12 ">
                        <label for="idlocation">Search Your Area Partial</label>
                        <div class="input-group">
                            <select name="idarea[]" id="idareafilter" class="form-control" required >
                            </select>
                        </div>
                    </div>
                    <div class="row col-sm-12">
