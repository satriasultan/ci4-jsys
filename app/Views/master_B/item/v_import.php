...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <form action="<?php echo base_url('master/item/proses_upload')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputFile">File Import Master Barang</label>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('assets/files/item/example/item_example.xlsx') ?>" class="btn btn-default  btn-sm"><i class="fa fa-file-excel-o"></i> Download Template </a>
                    <?php if ($adaisi>0) { ?>
                        <a href="<?= base_url('master/item/clear_tmp') ?>" class="btn btn-danger btn-sm float-right"><i class="fa fa-trash-o"></i> Clear Data </a>
                        <a href="<?= base_url('master/item/final_data') ?>" class="btn btn-primary btn-sm  float-right"><i class="fa fa-sign-in"></i> Final Data </a>
                    <?php } ?>
                </div>
            </form>
        </div><!-- /.card -->
                ...
                <table id="example1" class="table table-bordered table-striped" >
                    ...
                    <?php $no=0; foreach($list_detail as $lu): $no++;?>
                        <tr>
                            ...
                            <td><?php echo $lu->idgroup;?></td>
                            <td><?php echo $lu->unit;?></td>
                            <td><?php echo $lu->idbarcode;?></td>
                            <td><?php echo $lu->chold;?></td>
                            <td><?php echo $lu->nmlocation;?></td>
                            <td><?php echo $lu->nmarea;?></td>
                            <td><?php echo $lu->setminstock1;?></td>
                            <td><?php echo $lu->minstock1;?></td>
