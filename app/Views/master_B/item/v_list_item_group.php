    ...
    <div class="card-header">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"  onclick="add_mgroup()"><i class="fa fa-plus" ></i><?php echo '     Input'; ?> </a>
                <a class="dropdown-item" href="#"  onclick="reload_table()"><i class="fa fa-refresh"></i><?php echo '    Reload'; ?> </a>
            </div>
        </div>
    </div><!-- /.card-header -->
    <div class="card-body table-responsive" style='overflow-x:scroll;'>
        <table id="tmitem_group" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="1%" >No.</th>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="idgroup" placeholder="Group ID" class="form-control inform" type="text" MAXLENGTH="6" style="text-transform:uppercase;" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="nmgroup" placeholder="Group Name" class="form-control inform" type="text" style="text-transform:uppercase;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Group Type</label>
                            <div class="col-md-12">
                                <input name="grouptype" placeholder="Group Type" value="BRG" class="form-control inform" type="text" style="text-transform:uppercase;" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/master/mitem_group.js') ?>"></script>
