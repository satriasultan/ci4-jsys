...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Dashboard User</h4>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header d-flex align-items-center">
                    ...
                    <button class="btn btn-tool ms-auto" type="button" data-bs-toggle="collapse" 
                            data-bs-target="#tableFormpp" aria-expanded="false" aria-controls="tableFormpp">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header d-flex align-items-center">
                    ...
                    <button class="btn btn-tool ms-auto" type="button" data-bs-toggle="collapse" 
                            data-bs-target="#tableFormii" aria-expanded="false" aria-controls="tableFormii">
                        <i class="fa fa-chevron-circle-down"></i>
                    </button>
                </div>
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header d-flex align-items-center">
                    ...
                    <button class="btn btn-tool ms-auto" type="button" data-bs-toggle="collapse" 
                            data-bs-target="#tableFormpk" aria-expanded="false" aria-controls="tableFormpk">
                        <i class="fa fa-chevron-circle-down"></i>
                    </button>
                </div>
...
<?php } else { ?>
    <script type="application/javascript" src="<?= base_url('assets/pagejs/dashboard/dashboarduser.js') ?>"></script>
<?php } ?>
