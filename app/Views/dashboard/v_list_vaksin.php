                ...
                <table id="example1" class="table table-bordered table-striped" >
                    ...
                    <?php $no=0; foreach($list as $lu): $no++;?>
                        <tr>
                            ...
                            <td><?php echo date('d-m-Y',strtotime($lu->tglmasukkerja));?></td>
                            <td><?php if (empty($lu->lastdatevaksin)) {
                                    echo '';
                                } else {
                                    echo date('d-m-Y',strtotime($lu->lastdatevaksin));
                                }
                                ?>
                            </td>
                            <td><?php echo $lu->area_covid1;?></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
