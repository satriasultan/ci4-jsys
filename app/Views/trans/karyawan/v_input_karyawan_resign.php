        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-9" style="margin-top: 10px">
                    <?php /* <a href="<?php echo site_url('trans/karyawan/edit').'/'.$lp['nik'];?>" class="btn btn-primary pull-right" onclick="return confirm('Anda Yakin Ubah Data ini?')" style="margin:10px"><i class="fa fa-gear"></i> EDIT PROFILE KARYAWAN </a> */ ?>
