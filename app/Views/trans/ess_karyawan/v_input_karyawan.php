                ...
                <div class="col-sm-12">
					<div class="form-group">
						...
						<div class="col-sm-9" style="margin-top: 10px">
							<?php /* <a href="<?php echo base_url('trans/ess_karyawan/edit').'/'.$lp['nik'];?>" class="btn btn-primary pull-right" onclick="return confirm('Anda Yakin Ubah Data ini?')" style="margin:10px"><i class="fa fa-gear"></i> EDIT PROFILE KARYAWAN </a> */ ?>
                            <?php /* disable edit <button class="btn btn-success dropdown-toggle pull-right" style="margin:0px; color:#ffffff;" type="button" id="btnSave" onclick="saveInputKaryawan();"> Proses <i class="fa fa-arrow-right"></i></button> */ ?>
						</div>
