	...
	<div class="col-sm-12">
		...
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
				...
				<li><a href="#<?php echo str_replace('.','',trim($lp['nik']));?>tab_10" data-bs-toggle="tab">SP</a></li>
			</ul>
		</div>
                ...
                <div class="col-sm-6">
                    <div class="box box-info col-sm-12">
                        <div class="box-body" style="padding:5px;">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <a href="#" type="button" class="col-sm-4 btn btn-default" data-bs-toggle="modal" data-bs-target=".gantigambar">Ganti Foto</a>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <label for="darah" class="col-sm-4 control-label">Mobile Device ID</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" value="<?php echo trim($lp['deviceid']);?>" readonly>
                                    </div>
                                    <div class="col-sm-10"></div>
                                </div>
                            </div>
				...
				<div class="row">
                    <div class="box">
                          <div class="box-header">
					        <a href="#" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#inputmutasi"><i class="fa fa-plus"></i> Input Mutasi</a>
					      </div>
				...
				<div class="row">
                    <div class="box">
                          <div class="box-header">
					        ...
					        <a href="#" type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target="#inputstskerja"><i class="fa fa-plus"></i> Input Status Kerja</a>
                          </div>
                          <div class="box-body">
				...
				<div class="row">
                    <div class="box">
                        <div class="box-header">
				            ...
				            <a href="#" type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target=".keluarga"><i class="fa fa-plus"></i> Input Keluarga</a>
                        </div>
                        <div class="box-body">
				...
				<div class="row">
                    <div class="box">
                            <div class="box-header">
                                ...
                                <a href="#" type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target=".inputkerja"><i class="fa fa-plus"></i> Input Riwayat Kerja</a>
                            </div>
                          <div class="box-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-bs-toggle="modal" data-bs-target="#rwtpglm<?php echo trim($lu->no_urut);?>" href='#' class="btn btn-default  btn-sm">
                                            <i class="fa fa-edit"></i> Edit
                                        </a>
				...
				<div class="row">
                    <div class="box">
                        <div class="box-header">
				            ...
				            <a href="#" type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target=".inputpelatihan"><i class="fa fa-plus"></i> Input Pelatihan</a>
                        </div>
                          <div class="box-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#pennf<?php echo trim($lu->no_urut);?>" href='#' onclick="return confirm('Anda Yakin Edit Data ini?')" class="btn btn-default  btn-sm">
                                            <i class="fa fa-edit"></i> Edit
                                        </a>
                    ...
                    <div class="box">
                          <div class="box-header">
                              <h3>Riwayat Pendidikan Karyawan</h3>
                                <a href="#" type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target=".pendidikan"><i class="fa fa-plus"></i> Input Pendidikan</a>
                          </div>
                          <div class="box-body">
			...
			<div class="tab-pane" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_9">
				<div class="row">
                    <div class="box">
                        <div class="box-header">
                            <h3> BPJS Karyawan</h3>
                            <a href="#" type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target="#inputbpjs"><i class="fa fa-plus"></i> Input BPJS</a>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <table id="examplex" class="table table-bordered table-striped" >
                                    ...
                                    <?php $no=0; foreach($list_spkaryawan as $lu): $no++;?>
                                        <tr>
                                            ...
                                            <td><?php echo $lu->docname;?></td>
                                            <td><?php echo $lu->docref;?></td>
                                            <td><?php echo $lu->doctype;?></td>
                                            <td><?php echo date('d-m-Y',$lu->startdate);?></td>
                                            <td><?php echo date('d-m-Y',$lu->enddate);?></td>
                                            <td><?php echo $lu->description;?></td>
                                            <td><?php echo $lu->att_name;?></td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
                                </table>
