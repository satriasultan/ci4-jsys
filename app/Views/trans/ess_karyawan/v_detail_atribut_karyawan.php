...
<?php /*
<div class="col-sm-12">
    <a href="<?php echo base_url('trans/ess_karyawan/')?>" type="button" class="btn btn-default pull-left"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>
 */ ?>
...
<div class="nav-tabs-custom ">
    <ul class="nav nav-tabs">
        ...
        <li><a href="#tab_5" data-bs-toggle="tab">Histori Kesehatan</a></li>

        <li class="pull-right"><a href="<?php echo base_url('trans/ess_karyawan')?>" class="text-muted"><i class="fa fa-arrow-circle-left"></i> Kembali </a></li>
    </ul>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <select class="form-control input-sm" id="area_covid" name="area_covid" placeholder="Input Karyawan Telah Vaksin/Belum">
                                                        ...
                                                        <option value="VAKSIN2"> VAKSIN1 </option>
                            ...
                            <?php $no=0; foreach($riwayat_pendidikan as $rpf): $no++;?>
                                <tr>
                                    ...
                                    <td width="10%">
                                        ...
                                        <a class="btn btn-sm btn-danger"  onclick="return confirm('Anda Yakin Menghapus Data Ini?')" href="<?= base_url('/trans/ess_karyawan/save_pendidikanf_delete'.'/?id='.trim($rpf->id).'&nik='.trim($rpf->nik))?>"  title="Hapus Data" ><i class="fa fa-trash-o"></i> </a>
                                    </td>
                        ...
                        <?php $no=0; foreach($list_kartupendukung as $lkp): $no++;?>
                            <tr>
                                ...
                                <td width="10%">
                                    ...
                                    <a class="btn btn-sm btn-danger"  onclick="return confirm('Anda Yakin Menghapus Data Ini?')" href="<?= base_url('/trans/ess_karyawan/save_kartupendukung_delete'.'/?id='.trim($lkp->id).'&nik='.trim($lkp->nik))?>"  title="Hapus Data" ><i class="fa fa-trash-o"></i> </a>
                                </td>
...
<div class="modal fade" id="pendidikanf" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('trans/ess_karyawan/save_pendidikanf') ?>">
    ...
    <div class="modal fade" id="upd_pendidikanf<?= $uprpf->id ?>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url('trans/ess_karyawan/save_pendidikanf_update') ?>">
                    <div class="modal-body">
                        <div class="form-group input-sm ">
                            <label class="label-form col-sm-3">Kode Pendidikan</label>
                            <div class="col-sm-9">
...
<div class="modal fade" id="kartupendukung" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url('trans/ess_karyawan/save_kartupendukung') ?>">
                    <div class="modal-body">
                        <div class="form-group input-sm ">
    ...
    <div class="modal fade" id="upd_kartupendukung<?= $lkpz->id ?>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url('trans/ess_karyawan/save_kartupendukung_update') ?>">
                    <div class="modal-body">
                        <div class="form-group input-sm ">
                            <label class="label-form col-sm-3">Kode & Jenis Kartu</label>
                            <div class="col-sm-9">
