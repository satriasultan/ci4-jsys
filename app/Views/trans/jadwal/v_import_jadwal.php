...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form action="<?php echo site_url('trans/jadwal_new/proses_xls_jadwal')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <a href="<?= base_url('assets/files/jadwalkerja/jadwalregu/sample/template_jadwalkerja_regu.xlsx') ?>" class="btn btn-default"><i class="fa fa-file-excel-o"></i> Download Template </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#aturanMain" class="btn btn-default pull-right"><i class="fa fa-question-circle"></i></a>
                    <?php if ($adaisi>0) { ?>
                        <a href="<?= base_url('trans/jadwal_new/clear_tmp_jadwal_per_regu') ?>" class="btn btn-danger pull-right"><i class="fa fa-trash-o"></i> Clear Data </a>
                        <a href="<?= base_url('trans/jadwal_new/final_data_jadwal_per_regu') ?>" class="btn btn-primary pull-right"><i class="fa fa-sign-in"></i> Final Data </a>
                    <?php } ?>
