		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">
							...
							<div>&nbsp </div>
                <?php /*<form action="<?php echo site_url('trans/jadwal_new/load_verifikasi_mutasi_jadwalpernik')?>" method="post">*/ ?>
                                <div class="form-group input-sm">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control input-sm sl" name="nik" disabled>
                                    ...
                                    <div class="col-sm-1">
                                        <?php /*<button type="submit" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Load </button> */ ?>
                                    </div>
                                </div>
                <?php /*</form> */ ?>
                                 ...
                                 <div class="row">
                                     <form action="<?php echo site_url('trans/jadwal_new/simpan_verifikasi_mutasi_jadwalpernik')?>" method="post">
                                      <div class="col-md-4" >
                                          <div class="form-group input-sm">
                                          ...
                                          <div class="form-group input-sm">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl1" disabled>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl2" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl3" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl4" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm"  name="tgl5" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl6" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl7" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl8" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                          ...
                                          <div class="col-md-4">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl9" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm"  name="tgl10" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                      ...
                                      <div class="col-md-4" >
                                          ...
                                          <div class="form-group input-sm">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl11" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl12" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl13" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl14" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl15" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl16" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl17" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl18" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl19" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl20" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <div class="form-group input-sm">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl21" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl22" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl23" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                          ...
                                          <div class="form-group input-sm">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl24" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl25" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl26" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl27" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                          ...
                                          <div class="form-group input-sm tgl28" id="tgl28">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl28" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                          ...
                                          <div class="form-group input-sm tgl29" id="tgl29">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl29" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                          ...
                                          <div class="form-group input-sm tgl30" id="tgl30">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl30" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                          ...
                                          <div class="form-group input-sm tgl31" id="tgl31">
                                              ...
                                              <div class="col-sm-8">
                                                  <select class="form-control input-sm" name="tgl31" disabled>
                                                      <option value="OFF">OFF</option>
                                                      <?php foreach ($list_jamkerja as $ld){ ?>
                                         ...
                                         <div class="col-sm-12">
                                             <?php /* <button type="submit" class="btn btn-warning"><i class="fa fa-save"></i> PROCESS  </button> */ ?>
                                             <a href="<?php echo site_url("trans/jadwal_new/verifikasi_perubahan")?>"  class="btn btn-default" style="margin:10px; color:#000000;"><i class="fa fa-arrow-left"></i> Kembali</a>
                                            <?php /* <a href="<?php echo site_url("trans/jadwal_new/finalisasi_verifikasi_mutasi_jadwalpernik")?>"  class="btn btn-success pull-right" style="margin:10px; color:#ffffff;"><i class="fa fa-check"></i> FINAL </a> */ ?>
                                         </div>
                                     </form>
                                      </div>
                                  </div>
