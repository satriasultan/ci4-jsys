...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form action="<?php echo base_url('trans/lembur/proses_komponen_gp')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <a href="<?= base_url('assets/files/gp/example/gpx.xlsx') ?>" class="btn btn-default"><i class="fa fa-file-excel-o"></i> Download Template </a>
                </div>
            </form>
        </div><!-- /.box -->
    </div>
				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>
							...
							<td width="2%" class="ratakanan"><?php echo number_format($lu->gajipokok,2,',','.');?></td>
							<td width="2%" class="ratakanan"><?php echo number_format($lu->tjlembur,2,',','.');?></td>
						</tr>
						<?php endforeach;?>
					</tbody>
				</table>
