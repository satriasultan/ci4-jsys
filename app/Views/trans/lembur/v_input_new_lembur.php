...
<div class="box">
    ...
    <div class="box-body" >
        ...
        <form action="<?php echo base_url('#')?>" method="post" id="formInputLembur" role="form">
        <div class="col-lg-12">
 ...
 */ ?>
    ...
    <div class="box-footer">
        <div class="col-sm-12">
            <a href="<?php echo base_url('trans/lembur') ?>" class="btn btn-default dropdown-toggle " style="margin:0px; color:#000000;" type="button"><i class="fa fa-arrow-left"></i> Kembali </a>
