...
<div class="box">
    <div class="box-header">
        <div class="dropdown pull-right">
            <button class="btn btn-primary dropdown-toggle " style="margin:0px; color:#FFFFFF;" id="menu1" type="button" data-bs-toggle="dropdown"><?php echo $this->lang->line('menu'); ?>
                <span class="caret"></span></button>
            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
                <li role="presentation"><a role="menuitem" tabindex="-1" data-bs-toggle="modal" data-bs-target="#filter"  href="#" disabled="true"><i class="fa fa-filter"></i><?php echo $this->lang->line('filter'); ?></a></li>
                <li role="presentation"><a role="menuitem" tabindex="-2" href="#"  onclick="add_mkriteria()"><i class="fa fa-plus" ></i><?php echo $this->lang->line('input'); ?> </a></li>
                <li role="presentation"><a role="menuitem" tabindex="-3" href="#"  onclick="reload_table_kriteria()"><i class="fa fa-refresh"></i><?php echo $this->lang->line('reload'); ?> </a></li>
            </ul>
        </div>
    </div><!-- /.box-header -->
