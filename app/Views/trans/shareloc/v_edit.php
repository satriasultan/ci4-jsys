...
<div class="box">
    ...
    <div class="box-body" >
        <div class="col-lg-12">
            <h3 ALIGN="center"> INPUT LEMBUR KARYAWAN </h3>
        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="jabatan" placeholder="Jabatan / Section" disabled>
                    </div>
                    <!-- /.input group -->
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="nmgroupgol" placeholder="Group/ Golongan" disabled>
                    </div>
                    <!-- /.input group -->
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="durasijam" id="durasijam" placeholder="Input Durasi Jam Gunakan Titik Untuk Pecahan" maxlength="6">
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control col-sm-12 zz" name="kdlembur" id="kdlembur" placeholder="Pilih Tipe Lembur" >
