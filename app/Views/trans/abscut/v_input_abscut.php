 ...
 */ ?>
    ...
    <div class="box-footer">
        <div class="col-sm-12">
            <a href="<?php echo base_url('trans/abscut') ?>" class="btn btn-default dropdown-toggle " style="margin:0px; color:#000000;" type="button"><i class="fa fa-arrow-left"></i> Kembali </a>
