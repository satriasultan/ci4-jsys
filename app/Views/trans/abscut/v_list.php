		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">
					...
					<a href="<?php echo base_url("trans/abscut/input_new")?>"  class="btn btn-primary" style="margin:0px; color:#ffffff;"><i class="fa fa-plus"></i>  Input</a>
                    <?php } ?>
					...
					<tbody>
						...
						<tr>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" style="background: #b3efff">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <?php if (trim($lu->statusapprove)==='A' OR trim($lu->statusapprove)==='A1' OR trim($lu->statusapprove)==='A2') { ?>
                                            <li role="presentation"><a role="menuitem" title="Setujui" href="<?php $nik=trim($lu->nik); echo base_url("trans/abscut/setujui_abscut/").trim($lu->docno) ?>" onclick="return confirm('Anda Yakin Menyetujui Dokumen Ini?')" title="Setujui"><i class="fa fa-check-circle-o"></i> Setujui </a></li>
                                            <?php } ?>
                                            ...
                                            <?php if (trim($dtl_akses['a_update'])==='t') { ?>
                                                <li role="presentation"><a role="menuitem" title="Ubah" onclick="editDocument('<?php echo trim($lu->docno); ?>');"><i class="fa fa-gear"></i> Ubah </a></li>
                                            <?php } ?>
                                            <?php if (trim($dtl_akses['a_delete'])==='t') { ?>
                                                <li role="presentation"><a role="menuitem" title="Batalkan" href="<?php $nik=trim($lu->nik); echo base_url("trans/abscut/hps_abscut").'/'.trim($lu->docno) ?>" onclick="return confirm('Anda Yakin Membatalkan Data ini?')" title="Batalkan"><i class="fa fa-trash"></i> Batalkan </a></li>
                                            <?php }  ?>
                                        <?php }  ?>
                                    </ul>
                                </div>
                            ...
                            <?php } else if (trim($lu->statusapprove) === 'A2') { ?>
                                <td><span class="label label-primary"><?php echo $lu->nmstatusapprove;?></span></td>
            ...
            <div class="col-sm-12">
                <div class="box" style="background-color: #c7e9bb">
                    <div class="box-title" align="center">
                        <h2> Resume Per - Departmen Absensi Periode  <?= $tglresume1.' s/d '.$tglresume2?></h2>
                    </div>
                    <div class="box-header">
                        <div class="col-sm-12">
...
<div class="modal fade" id="filter" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	  ...
	  <form action="<?php echo base_url('trans/abscut')?>" method="post">
...
<div class="modal fade" id="downloadXls" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('trans/abscut/downloadExcel')?>" method="post">
                <div class="modal-body">
                    <div class="form-group input-sm ">
                        <label class="label-form col-sm-3">Tanggal</label>
                        <div class="col-sm-9">
...
<div class="modal fade" id="downloadXlsResume" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('trans/abscut/downloadResumeExcel')?>" method="post">
                <div class="modal-body">
                    <div class="form-group input-sm ">
                        <label class="label-form col-sm-3">Tanggal</label>
                        <div class="col-sm-9">
...
<script type="text/javascript" src="<?= base_url('assets/pagejs/trans/abscut.js') ?>"></script>
