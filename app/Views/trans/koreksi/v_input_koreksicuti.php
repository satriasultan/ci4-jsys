...
<div class="box">
    <div class="box-header">
            <div class="col-sm-12">
                <?php if (trim($type)==='DETAIL') { ?>
                    <a href="<?php echo base_url("trans/koreksi/koreksicuti")?>" class="btn btn-default dropdown-toggle " style="margin:0px; color:#000000;" type="button"><i class="fa fa-arrow-left"></i> Kembali </a>
                <?php } else { ?>
                    <a href="<?php echo base_url("trans/koreksi/clearEntry_Koreksi_Cuti")?>" class="btn btn-default dropdown-toggle " style="margin:0px; color:#000000;" type="button"><i class="fa fa-arrow-left"></i> Kembali </a>
                <?php } ?>
    ...
    <div class="box-body" >
        <form id="form" action="<?php echo base_url('#')?>" method="post" enctype="multipart/form-data" role="form">
        <div class="col-lg-12">
