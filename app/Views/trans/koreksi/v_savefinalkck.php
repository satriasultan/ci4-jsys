...
<form action="<?php echo site_url('trans/koreksi/save_finalkck')?>" method="post">
<div class="modal-body">										
					...
					<script type="text/javascript" charset="utf-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
										...
										<input value="<?php echo trim($dtl['tgl_awal']) ?>" type="text" id="tglmulai" name="tgl_awal" data-date-format="dd-mm-yyyy"  class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input value="<?php echo trim($dtl['jumlahcuti']) ?>"  type="number" id="jumlahcuti" name="jumlahcuti" placeholder="0"   class="form-control" required >
								</div>	
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
										...
										<input value="<?php echo trim($dtl['input_date']) ?>"  type="text" id="tgl1" name="tgl" class="form-control" readonly>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea value="<?php echo ($dtl['keterangan']);?>" type="text" id="keterangan1" name="keterangan"   style="text-transform:uppercase" class="form-control"></textarea>
									...
									<input value="<?php echo ($dtl['nodok']);?>" type="hidden" id="nodok1" name="nodok" class="form-control" readonly>
								</div>
							</div>		
	...
	<div> 
        <a href="<?php echo site_url('trans/koreksi/koreksi_khusus');?>" type="button" class="btn btn-default"/> Kembali</a>
