...
<div class="row">
    <div class="col-sm-12">
        <div class="box">
            <form action="<?php echo base_url('report/presensi/showupPresensi')?>" method="post">
                ...
                <div class="box-body">
                    <div class="form-group input-sm ">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="periode" id="periode" class="form-control input-sm periode" required>
                        </div>
                    </div>
                    <div class="form-group input-sm ">
