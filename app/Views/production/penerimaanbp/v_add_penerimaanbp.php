...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            ...
            <!-- LEFT -->
            <div class="col-sm-6">
                <h1 class="m-0">Penerimaan Barang Produksi</h1>
            </div>
...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('production/trans/final_input_penerimaanbp') ?>" method="post" id="formStandarCostMst">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Penerimaan Barang Produksi</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" >
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>No. Penerimaan Barang Produksi</label>
                                            <div class="d-flex">
                                                <input type="text"
                                                    name="prefix"
                                                    id="prefix"
                                ...
                                <div class="row">
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="idlocation" id="idlocation" class="form-select select2 " required style="width:100%">
                                            </select>
                                        </div>
                                    </div> -->
                                    <input type="hidden" name="nmlocation" class="form-control col-sm-12" id="nmlocation" maxlength="20"  style="text-transform: uppercase;" readonly>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">No. Terima Antar Bagian</label>
                                            <select name="tabno" id="tabno" class="form-select select2 " style="width:100%">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">No. Work Order Execution</label>
                                            <select name="woeno" id="woeno" class="form-select select2 " style="width:100%">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="wono" id="wono" class="form-select select2 " style="width:100%">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="bomno" id="bomno" class="form-select select2 " style="width:100%">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="col-md-3" >
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">No. Batch Reff</label>
                                            <div class="form-group">
                                                <input type="text" name="batchno" id="batchno" class="form-control" placeholder="No. Batch Reff">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="from">Untuk Bagian</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="keterangan" id="keterangan" class="form-control" rows="2" placeholder="Catatan / Informasi..." style="text-transform:uppercase;"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- END ROW 2-->
            ...
            <div class="card mt-3 card-primary">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="tmp_penerimaanbpdtl"
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="8" style="background-color: #d5d5d5; text-align: right!important;" >
                                        TOTAL NILAI
                                    </th>
                                    <th id="ttlprice" class="text-right" style="font-weight: bold;">
                                        0
                                    </th>
                                </tr>
                            </tfoot>
                ...
                <div class="card-footer bg-light">
                    ...
                    <a href="<?= base_url('production/trans/clear_penerimaanbp_Tmp') ?>"
...
<!-- =================MODAL Penerimaan Barang Produksi  ================= -->
<div class="modal fade" id="modalDtlPBP" tabindex="-1" role="dialog" aria-labelledby="modalDtlPBP" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">

            <!-- HEADER -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="modalDtlPBPTitle">
                    Input Penerimaan Barang Produksi
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>

            <!-- FORM -->
            <form id="formPBPMaterialDtl">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3" id="divItemBom">
                            <label class="form-label">BOM Item</label>
                            <select id="idbarang_bom"
                                    name="idbarang_bom"
                        ...
                        <div class="col-md-3" id="divItemSub" style="display:none;">
                            <label class="form-label">Substitute Item</label>
                            <select id="idbarang"
                                    name="idbarang"
                                    class="form-select select2"
                                    style="width:100%">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text"
                                    ...
                                    onchange="hitungTotalCost()"
                                    onkeyup="hitungTotalCost()"
                                    style="text-transform:uppercase">
                        </div>
                        <div class="col-md-1">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"
                            ...
                            onclick="savePBPDetail('formPBPMaterialDtl')">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/production/penerimaanbp/penerimaanbp.js') ?>"></script>
