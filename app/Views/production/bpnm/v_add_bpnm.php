...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            ...
            <!-- LEFT -->
            <div class="col-sm-6">
                <h1 class="m-0">Biaya Produksi Non Material</h1>
            </div>
...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('production/trans/final_input_bpnm') ?>" method="post" id="formStandarCostMst">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Biaya Produksi Non Material</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" >
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>No. Biaya Produksi Non Material</label>
                                            <div class="d-flex">
                                                <input type="text"
                                                    name="prefix"
                                                    id="prefix"
            ...
            <div class="card mt-3 card-primary">
                ...
                <div class="card-footer bg-light">
                    ...
                    <a href="<?= base_url('production/trans/clear_bpnm_Tmp') ?>"
...
<!-- =================MODAL Biaya Produksi Non Material  ================= -->
<div class="modal fade" id="modalDtlBPNM" tabindex="-1" role="dialog" aria-labelledby="modalDtlBPNM" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">

            <!-- HEADER -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="modalDtlBPNMTitle">
                    Input Biaya Produksi Non Material
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>

            <!-- FORM -->
            <form id="formBPNMMaterialDtl">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"
                            ...
                            onclick="saveBPNMDetail('formBPNMMaterialDtl')">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/production/bpnm/bpnm.js') ?>"></script>
