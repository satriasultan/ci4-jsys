        ...
        <div class="col-md-12">
            ...
            <div class="card mt-3 card-primary">
                ...
                <div class="card-footer bg-light">
                    ...
                    <a href="<?= base_url('production/trans/biaya_produksi_non_material') ?>"
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/production/bpnm/bpnm_trx.js') ?>"></script>
