                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">Build For</label>
                                                    <div class="form-group">
                                                        <input type="numeric" name="buildfor" id="buildfor" class="form-control" placeholder="Build Qty For" required>
                                                    </div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <input type="numeric" name="minimumqty" id="minimumqty" class="form-control" placeholder="Build Qty For" >
                                                </div>
                                            </div>
                                    </div>
                                </div>
