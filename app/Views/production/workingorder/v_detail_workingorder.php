        ...
        <div class="col-md-12">
            ...
            <div class="card mt-3 card-primary">
                ...
                <div class="card-body p-4">
                    <div class="table-responsive">
                        <table id="trx_workingorderbommst"
            ...
            <div class="card mt-3 card-primary">
                        ...
                        <div class="tab-pane fade show active"
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="trx_workingordermaterialdtl"
                                            class="table table-hover align-middle custom-table">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="trx_workingordercostdtl"
                                                class="table table-hover align-middle custom-table">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="trx_workingorderwipdtl"
                                                class="table table-hover align-middle custom-table">
                ...
                <div class="card-footer bg-light">
                    ...
                    <a href="<?= base_url('production/trans/workingorder') ?>"
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/production/workingorder/workingorder_trx.js') ?>"></script>
