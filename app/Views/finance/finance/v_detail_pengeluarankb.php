...
<div class="row">
    <!-- left column -->
    <form action="<?= base_url('ka/finance/finalEntryPengeluaranKB') ?>" method="post" id="formPO">
        <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?=  $typeTitle = ($typeform == 'INPUT') ? 'Input' : ($typeform == 'UPDATE' ? 'Edit' : 'Detail'); ?> Pengeluaran Kas/Bank</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                        <div class="section-block">
                            <div class="section-header">
                                <i class="fa fa-address-card"></i> Pengeluaran Kas/Bank
                            </div>
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="kdsupplier" id="kdsupplier" disabled class="form-control select2" required></select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="row" style="margin-top: -25px;">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="prkkas" id="prkkas" class="form-control" required>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
            ...
            <div class="card mt-3 card-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive" style="overflow-x: auto;">
                                <table id="tabpengeluarankbdtl" class="table table-bordered table-striped" style="width:100%;" cellspacing="0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="8" style="background-color: #ffe483;" class="text-right">
                                                TOTAL NILAI
                                            </th>
                ...
                <div class="card-footer bg-light">
                    <a href="<?= base_url('ka/finance/pengeluarankb') ?>"
...
<div class="modal fade" id="modalDetailPengeluaranKB" tabindex="-1" role="dialog" aria-labelledby="modalDetailPengeluaranKBLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">

            <!-- HEADER -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="modalDetailPengeluaranKBLabel">
            ...
            <!-- FORM -->
            <form id="formPengeluaranKBDetail">
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="button"
                        ...
                        onclick="savePengeluaranKBDetail()">
                        <i class="fa fa-save"></i> Simpan
                    </button>
                    <button type="button"
                            class="btn btn-secondary"
                            data-bs-dismiss="modal"
                            onclick="$('#modalDetailPengeluaranKB').modal('hide')">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/finance/pengeluarankb_detail.js') ?>"></script>
