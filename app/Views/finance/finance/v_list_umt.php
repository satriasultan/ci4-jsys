                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($dtl_akses['a_input']) && trim($dtl_akses['a_input']) === 't'): ?>
                            <a class="dropdown-item" href="<?= base_url('ka/finance/addUMT') ?>"><i class="fa fa-plus"></i><?php echo '   Input'; ?> </a>
                        <?php endif; ?>
                            <!-- <a class="dropdown-item disabled" data-bs-toggle="modal" data-bs-target="#filter"  href="#"><i class="fa fa-filter"></i><?php echo '   Filter'; ?></a> -->
                        <a class="dropdown-item" href="#"  onclick="reload_tableUMTTrx()"><i class="fa fa-refresh"></i><?php echo '    Reload'; ?> </a>
                    </div>
                </div>
            </div><!-- /.card-header -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive"  style='overflow-x:auto;'>
                            <table id="tableumtTrx" class="table table-bordered table-striped"  style="width:100%;" cellspacing="0">
