                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="kdcustomer" id="kdcustomer" disabled class="form-control select2" required></select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
...
<script type="application/javascript" src="<?= base_url('assets/pagejs/finance/penerimaankb_detail.js') ?>"></script>
